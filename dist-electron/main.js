...
var N_ = (i, e, t) => e in i ? D_(i, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : i[e] = t;
var Zt = (i, e, t) => N_(i, typeof e != "symbol" ? e + "" : e, t);
import B_, { app as ti, ipcMain as ge, BrowserWindow as Fd } from "electron";
import { fileURLToPath as U_ } from "node:url";
import pt from "node:path";
import Lt, { TextEncoder as z_ } from "util";
import Re from "path";
import Gi from "fs";
import Ec from "crypto";
import qd from "os";
import _n, { Readable as H_ } from "stream";
import Rc from "http";
import Sc from "https";
import Ls from "url";
import G_ from "assert";
import kc from "tty";
import dt from "zlib";
import { EventEmitter as W_ } from "events";
import K_, { spawn as Mp } from "child_process";
import J_ from "net";
...
const n0 = (i) => {
  ...
  "undefined",
  "function"
].some((e) => e === i), ji = (i) => i === null ? "null" : Array.isArray(i) ? "array" : Buffer.isBuffer(i) ? "buffer" : typeof i, t0 = (i, e, t) => t.indexOf(i) === e, i0 = (i) => {
  let e = ji(i), t;
  return e === "array" && (t = i.map((s) => ji(s)).filter(t0), e += ` of ${t.join(", ")}`), e;
}, a0 = (i, e) => {
  const t = jd(e);
  ...
  if (!s.some((c) => {
    ...
    return $d(c) ? a0(t, c) : c === ji(t);
  }))
    throw new Error(
      `Argument "${e}" passed to ${i} must be ${n0(
        s
      )}. Received ${i0(t)}`
    );
}, s0 = (i, e, t, s) => {
...
var si = {};
const Nd = pn, r0 = ze, o0 = (i, e) => {
  const t = `${i}([path])`;
  r0.argument(t, "path", e, ["string", "undefined"]);
}, c0 = (i) => {
  Nd.rmSync(i, {
    recursive: !0,
    force: !0,
...
si.sync = c0;
si.async = u0;
const $s = Re, Nn = pn, Tc = qs, Ip = ze, Bd = si, l0 = (i, e, t) => {
...
}, x0 = (i, e) => new Promise((t, s) => {
  const o = Ud(e);
  m0(i).then((c) => c !== void 0 ? v0(
    i,
    c,
    o
  ) : Oc(i, o)).then(t, s);
...
Pn.async = x0;
Pn.createAsync = Oc;
const Hd = Re, ii = pn, Ao = ze, Gd = Pn, g0 = (i, e, t, s) => {
  ...
  let c = Kd;
  s.atomic && (c = b0), c(i, o, { mode: s.mode });
...
}), w0 = (i, e, t) => new Promise((s, o) => {
  Jd(i + bs, e, t).then(() => ii.rename(i + bs, i)).then(s, o);
}), _0 = (i, e, t) => {
  const s = t || {}, o = Wd(e, s.jsonIndent);
  let c = Jd;
  return s.atomic && (c = w0), c(i, o, { mode: s.mode });
};
Ft.validateInput = g0;
Ft.sync = y0;
Ft.async = _0;
const Vd = pn, Xd = Ft, To = ze, E0 = (i, e, t, s) => {
  const o = `${i}(path, data, [options])`;
...
Fs.async = S0;
var js = {};
const Ds = pn, Pc = qs, Lp = ze, Ns = Ft, k0 = (i, e, t) => {
  const s = `${i}(path, [criteria])`;
  ...
  const t = Yd(e), s = A0(i);
  s !== void 0 ? T0(i, s, t) : C0(i, t);
}, P0 = (i) => new Promise((e, t) => {
  Ds.stat(i).then((s) => {
    s.isFile() ? e(s) : t(Zd(i));
  }).catch((s) => {
    s.code === "ENOENT" ? e(void 0) : t(s);
...
}, L0 = (i, e) => new Promise((t, s) => {
  const o = Yd(e);
  P0(i).then((c) => c !== void 0 ? M0(i, c, o) : I0(i, o)).then(t, s);
});
js.validateInput = k0;
js.sync = O0;
js.async = L0;
var Bs = {}, Wi = {}, Bn = {};
const Qd = Ec, F0 = Re, ft = pn, Fp = ze, Zo = ["md5", "sha1", "sha256", "sha512"], Qo = ["report", "follow"], q0 = (i, e, t) => {
  ...
  const s = {};
  return s.name = F0.basename(i), t.isFile() ? (s.type = "file", s.size = t.size) : t.isDirectory() ? s.type = "dir" : t.isSymbolicLink() ? s.type = "symlink" : s.type = "other", e.mode && (s.mode = t.mode), e.times && (s.accessTime = t.atime, s.modifyTime = t.mtime, s.changeTime = t.ctime, s.birthTime = t.birthtime), e.absolutePath && (s.absolutePath = i), s;
}, $0 = (i, e) => {
  const t = Qd.createHash(e), s = ft.readFileSync(i);
  return t.update(s), t.digest("hex");
}, j0 = (i, e, t) => {
  e.type === "file" && t.checksum ? e[t.checksum] = $0(i, t.checksum) : e.type === "symlink" && (e.pointsAt = ft.readlinkSync(i));
}, D0 = (i, e) => {
...
}), B0 = (i, e, t) => e.type === "file" && t.checksum ? N0(i, t.checksum).then((s) => (e[t.checksum] = s, e)) : e.type === "symlink" ? ft.readlink(i).then((s) => (e.pointsAt = s, e)) : Promise.resolve(e), U0 = (i, e) => new Promise((t, s) => {
  let o = ft.lstat;
  const c = e || {};
...
Bn.async = U0;
var Us = {};
const nf = pn, z0 = ze, H0 = (i, e) => {
  const t = `${i}(path)`;
  z0.argument(t, "path", e, ["string", "undefined"]);
}, G0 = (i) => {
  try {
...
Us.sync = G0;
Us.async = W0;
const ys = Gi, ws = Re, $i = Bn, _s = (i) => i.isDirectory() ? "dir" : i.isFile() ? "file" : i.isSymbolicLink() ? "symlink" : "other", K0 = (i, e, t) => {
...
Wi.async = V0;
var Mc = {};
const X0 = typeof process == "object" && process && process.platform === "win32";
var Y0 = X0 ? { sep: "\\" } : { sep: "/" }, Z0 = tf;
function tf(i, e, t) {
...
var sf = Z0, Q0 = t1, rf = "\0SLASH" + Math.random() + "\0", of = "\0OPEN" + Math.random() + "\0", Ic = "\0CLOSE" + Math.random() + "\0", cf = "\0COMMA" + Math.random() + "\0", uf = "\0PERIOD" + Math.random() + "\0";
function Co(i) {
...
function t1(i) {
  return i ? (i.substr(0, 2) === "{}" && (i = "\\{\\}" + i.substr(2)), qi(e1(i), !0).map(n1)) : [];
}
function i1(i) {
  return "{" + i + "}";
}
...
function qi(i, e) {
  ...
  if (/\$$/.test(s.pre))
    ...
    if (h)
      y = s.body.split(/\.\./);
    else if (y = lf(s.body), y.length === 1 && (y = qi(y[0], !1).map(i1), y.length === 1))
      return c.map(function(Pe) {
        return s.pre + y[0] + Pe;
      });
    var S;
    if (h) {
      var _ = Co(y[0]), O = Co(y[1]), C = Math.max(y[0].length, y[1].length), F = y.length == 3 ? Math.abs(Co(y[2])) : 1, $ = s1, q = O < _;
      q && (F *= -1, $ = r1);
      var G = y.some(a1);
      S = [];
      for (var z = _; $(z, O); z += F) {
...
const o1 = Q0, $p = {
  ...
  "*": { open: "(?:", close: ")*" },
  "@": { open: "(?:", close: ")" }
}, nc = "[^/]", Oo = nc + "*?", c1 = "(?:(?!(?:\\/|^)(?:\\.{1,2})($|\\/)).)*?", u1 = "(?:(?!(?:\\/|^)\\.).)*?", df = (i) => i.split("").reduce((e, t) => (e[t] = !0, e), {}), jp = df("().*{}+?[]^$\\!"), l1 = df("[.("), Dp = /\/+/;
...
const ff = (i, e = {}) => (Es(i), e.nobrace || !/\{(?:(?!\{).)*\}/.test(i) ? [i] : o1(i)), p1 = 1024 * 64, Es = (i) => {
  if (typeof i != "string")
...
const d1 = (i) => i.replace(/\\(.)/g, "$1"), f1 = (i) => i.replace(/\\([^-\]])/g, "$1"), m1 = (i) => i.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, "\\$&"), h1 = (i) => i.replace(/[[\]\\]/g, "\\$&");
let zs = class {
  constructor(e, t) {
...
>>> no match, partial?`, e, g, t, y), g === p));
  ...
  makeRe() {
    ...
    const t = this.options, s = t.noglobstar ? Oo : t.dot ? c1 : u1, o = t.nocase ? "i" : "";
    let c = e.map((l) => (l = l.map(
      (p) => typeof p == "string" ? m1(p) : p === Cn ? Cn : p._src
...
Mc.create = (i, e, t) => {
  ...
  const o = s.map((l) => x1(i, l)).map((l) => new v1(l, {
    matchBase: !0,
    nocomment: !0,
    nocase: t || !1,
    dot: !0,
...
const g1 = Re, mf = Wi, hf = Bn, vf = Mc, Np = ze, b1 = (i, e, t) => {
  const s = `${i}([path], options)`;
...
}, gf = (i, e) => i.map((t) => g1.relative(e, t)), bf = (i) => {
...
}), E1 = (i, e) => hf.async(i, { symlinks: "follow" }).then((t) => {
  if (t === void 0)
    throw bf(i);
  if (t.type !== "dir")
    throw yf(i);
...
Bs.async = E1;
var Hs = {};
const R1 = Ec, Rs = Re, Wa = Bn, Bp = ze, wf = Wi, S1 = (i, e, t) => {
  const s = `${i}(path, [options])`;
...
}, k1 = (i, e) => i === void 0 ? "." : i.relativePath + "/" + e.name, A1 = (i, e) => {
  const t = R1.createHash(e);
  return i.forEach((s) => {
    t.update(s.name + s[e]);
  }), t.digest("hex");
}, Lc = (i, e, t) => {
  t.relativePath && (e.relativePath = k1(i, e)), e.type === "dir" && (e.children.forEach((s) => {
    Lc(e, s, t);
...
Hs.async = C1;
var Ki = {}, ri = {};
const _f = pn, O1 = ze, P1 = (i, e) => {
  const t = `${i}(path)`;
  O1.argument(t, "path", e, ["string"]);
}, M1 = (i) => {
  try {
...
ri.sync = M1;
ri.async = I1;
const Di = Re, cn = pn, qc = Pn, Ss = ri, Ef = Bn, L1 = Ft, F1 = Mc, Rf = qs, Sf = Wi, Mo = ze, q1 = (i, e, t, s) => {
  ...
  const t = i || {}, s = {};
  return t.ignoreCase === void 0 && (t.ignoreCase = !1), s.overwrite = t.overwrite, t.matching ? s.allowedToCopy = F1.create(
    e,
    t.matching,
    t.ignoreCase
  ) : s.allowedToCopy = () => !0, s;
  ...
  times: !0,
  absolutePath: !0
}, Tf = (i) => typeof i.opts.overwrite != "function" && i.opts.overwrite !== !0, $1 = (i, e, t) => {
  if (!Ss.sync(i))
    throw Af(i);
  ...
  e.type === "dir" ? qc.createSync(t, { mode: c }) : e.type === "file" ? D1(i, t, c, o) : e.type === "symlink" && N1(i, t);
}, U1 = (i, e, t) => {
  const s = kf(t, i);
  $1(i, e, s), Sf.sync(i, { inspectOptions: Ws }, (o, c) => {
    const l = Di.relative(i, o), p = Di.resolve(e, l);
    s.allowedToCopy(o, p, c) && B1(o, c, p, s);
  });
}, z1 = (i, e, t) => Ss.async(i).then((s) => {
  if (s)
    return Ss.async(e);
  throw Af(i);
}).then((s) => {
  ...
  m.on("error", l), h.on("error", (g) => {
    ...
    }).catch(l) : g.code === "EEXIST" ? H1(s).then((y) => {
      y ? tc(i, e, t, s, {
        overwrite: !0
      }).then(c, l) : Tf(s) ? l(Gs(e)) : c();
    }).catch(l) : l(g);
  }), h.on("finish", c), m.pipe(h);
}), G1 = (i, e) => cn.readlink(i).then((t) => new Promise((s, o) => {
  cn.symlink(t, e).then(s).catch((c) => {
    c.code === "EEXIST" ? cn.unlink(e).then(() => cn.symlink(t, e)).then(s, o) : o(c);
  });
})), W1 = (i, e, t, s) => {
  const o = { srcPath: i, destPath: t, srcInspectData: e, opts: s }, c = Rf.normalizeFileMode(e.mode);
  return e.type === "dir" ? qc.createAsync(t, { mode: c }) : e.type === "file" ? tc(i, t, c, o) : e.type === "symlink" ? G1(i, t) : Promise.resolve();
}, K1 = (i, e, t) => new Promise((s, o) => {
  const c = kf(t, i);
  z1(i, e, c).then(() => {
    let l = !1, p = 0;
    Sf.async(
      ...
      (f, m) => {
        if (m) {
          ...
          c.allowedToCopy(f, m, g) && (p += 1, W1(f, m, g, c).then(() => {
            p -= 1, l && p === 0 && s();
          }).catch(o));
        }
      },
...
Ki.async = K1;
var Ji = {};
const Cf = Re, ni = pn, Io = ze, Of = Ki, Pf = Pn, Ni = ri, ks = si, J1 = (i, e, t, s) => {
  const o = `${i}(from, to, [options])`;
    ...
    Ni.async(e).then((l) => {
      l !== !1 && s.overwrite !== !0 ? c(If(e)) : ni.rename(i, e).then(o).catch((p) => {
        p.code === "EISDIR" || p.code === "EPERM" ? ks.async(e).then(() => ni.rename(i, e)).then(o, c) : p.code === "EXDEV" ? Of.async(i, e, { overwrite: !0 }).then(() => ks.async(i)).then(o, c) : p.code === "ENOENT" ? Ni.async(i).then((f) => {
          f ? X1(e).then(() => ni.rename(i, e)).then(o, c) : c(Lf(i));
        }).catch(c) : c(p);
      });
    });
  });
...
Ji.async = Y1;
var Ks = {};
const Ff = pn, Up = ze, zp = ["utf8", "buffer", "json", "jsonWithDates"], Z1 = (i, e, t) => {
...
Ks.async = eE;
var Js = {};
const Bi = Re, jf = Ji, Lo = ze, nE = (i, e, t, s) => {
...
Js.async = iE;
var Vs = {};
const Df = Re, As = pn, Hp = ze, Nf = Pn, aE = (i, e, t) => {
...
var Xs = {};
const jc = Re, oE = qd, Uf = Ec, zf = Pn, Hf = pn, cE = ze, uE = (i, e) => {
  const t = `${i}([options])`;
  cE.options(t, "options", e, {
    prefix: ["string"],
    basePath: ["string"]
  });
}, Gf = (i, e) => {
  i = i || {};
  const t = {};
  return typeof i.prefix != "string" ? t.prefix = "" : t.prefix = i.prefix, typeof i.basePath == "string" ? t.basePath = jc.resolve(e, i.basePath) : t.basePath = oE.tmpdir(), t;
}, Wf = 32, lE = (i, e) => {
...
const fE = dE;
var ue = fE();
const oi = ti.getPath("sessionData"), mE = Re.join(oi, "Playlists"), De = Re.join(mE, "meta.json"), Jf = (i) => Re.join(oi, `Playlists/${i}`), Pt = (i, e) => Re.join(oi, `Playlists/${i}/user/${e}.json`), Vf = (i) => Re.join(oi, `Playlists/${i}/vod.json`), Xf = (i) => Re.join(oi, `Playlists/${i}/series.json`), Yf = (i) => Re.join(oi, `Playlists/${i}/live.json`);
async function qt() {
...
const gE = Zs("string"), ln = Zs("function"), em = Zs("number"), Qs = (i) => i !== null && typeof i == "object", bE = (i) => i === !0 || i === !1, vs = (i) => {
  if (Ys(i) !== "object")
    return !1;
  const e = Dc(i);
...
}, kE = Mn("URLSearchParams"), [AE, TE, CE, OE] = ["ReadableStream", "Request", "Response", "Headers"].map(Mn), PE = (i) => i.trim ? i.trim() : i.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "");
...
}, { allOwnKeys: s }), i), IE = (i) => (i.charCodeAt(0) === 65279 && (i = i.slice(1)), i), LE = (i, e, t, s) => {
...
), Kp = (({ hasOwnProperty: i }) => (e, t) => i.call(e, t))(Object.prototype), zE = Mn("RegExp"), im = (i, e) => {
...
}, KE = (i, e) => i != null && Number.isFinite(i = +i) ? i : e, qo = "abcdefghijklmnopqrstuvwxyz", Jp = "0123456789", am = {
  DIGIT: Jp,
  ALPHA: qo,
  ALPHA_DIGIT: qo + qo.toUpperCase() + Jp
}, JE = (i = 16, e = am.ALPHA_DIGIT) => {
  let t = "";
  const { length: s } = e;
  for (; i--; )
    t += e[Math.random() * s | 0];
...
const XE = (i) => {
  ...
  return t(i, 0);
}, YE = Mn("AsyncFunction"), ZE = (i) => i && (Qs(i) || ln(i)) && ln(i.then) && ln(i.catch), sm = ((i, e) => i ? setImmediate : e ? ((t, s) => (Tt.addEventListener("message", ({ source: o, data: c }) => {
  ...
  ln(Tt.postMessage)
), QE = typeof queueMicrotask < "u" ? queueMicrotask.bind(Tt) : typeof process < "u" && process.nextTick || sm, k = {
  isArray: ci,
  isArrayBuffer: Qf,
  isBuffer: vE,
  isFormData: SE,
...
var tR = Lt, um = _n.Stream, Vp = nR, iR = Ee;
function Ee() {
...
var er = { exports: {} }, Zp = fm, ER = mm, RR = hm;
er.exports = SR;
...
}, Nc = iR, MR = Lt, $o = Re, IR = Rc, LR = Sc, FR = Ls.parse, qR = Gi, $R = _n.Stream, jo = lm, jR = OR, ac = PR, DR = ce;
MR.inherits(ce, Nc);
function ce(i) {
...
ce.prototype.submit = function(i, e) {
  ...
  return typeof i == "string" ? (i = FR(i), s = ac({
    ...
    host: i.hostname,
    protocol: i.protocol
  }, o)) : (s = ac(i, o), s.port || (s.port = s.protocol == "https:" ? 443 : 80)), s.headers = this.getHeaders(i.headers), s.protocol == "https:" ? t = LR.request(s) : t = IR.request(s), this.getLength((function(c, l) {
...
var dS = lS, Gc = { exports: {} }, us = { exports: {} }, ls = { exports: {} }, Bo, id;
function fS() {
  if (id) return Bo;
  id = 1;
...
function vS() {
  if (od) return Ho;
  od = 1;
  const i = qd, e = kc, t = hS(), { env: s } = process;
  let o;
...
var ud;
function gS() {
  return ud || (ud = 1, typeof process > "u" || process.type === "renderer" || process.browser === !0 || process.__nwjs ? us.exports = mS() : us.exports = xS()), us.exports;
}
var Li, bS = function() {
  if (!Li) {
    try {
...
}, Yi = Ls, zi = Yi.URL, yS = Rc, wS = Sc, Wc = _n.Writable, Kc = G_, Sm = bS;
(function() {
...
Qe.prototype._processResponse = function(i) {
  ...
  if (Sm("redirecting to", h.href), this._isRedirect = !0, uc(h, this._options), (h.protocol !== p.protocol && h.protocol !== "https:" || h.host !== f && !TS(h.host, f)) && Go(/^(?:(?:proxy-)?authorization|cookie)$/i, this._options.headers), Mt(o)) {
    var g = {
      headers: i.headers,
      statusCode: e
    }, y = {
...
function km(i) {
  ...
  return Object.keys(i).forEach(function(s) {
    ...
    function p(m, h, g) {
      return OS(m) ? m = uc(m) : Ct(m) ? m = uc(Yc(m)) : (g = h, h = Tm(m), m = { protocol: o }), Mt(h) && (g = h, h = null), h = Object.assign({
...
Gc.exports = km({ http: yS, https: wS });
Gc.exports.wrap = km;
var PS = Gc.exports;
const MS = /* @__PURE__ */ Ac(PS), Ts = "1.7.7";
function Cm(i) {
...
}, FS = k.ALPHABET.ALPHA_DIGIT + "-_", Hi = new z_(), lt = `\r
`, qS = Hi.encode(lt), $S = 2;
class jS {
  constructor(e, t) {
  ...
  async *encode() {
    yield this.headers;
    const { value: e } = this;
    k.isTypedArray(e) ? yield e : yield* Om(e), yield qS;
  }
  static escapeName(e) {
...
const DS = (i, e, t) => {
  ...
  return Number.isFinite(f) && (h["Content-Length"] = f), e && e(h), H_.from(async function* () {
    for (const g of m)
...
}, fd = k.isFunction(dt.createBrotliDecompress), { http: GS, https: WS } = MS, KS = /https:?/, md = Le.protocols.map((i) => i + ":"), hd = (i, [e, t]) => (i.on("end", t).on("error", t), e);
function JS(i, e) {
...
const VS = typeof process < "u" && k.kindOf(process) === "process", XS = (i) => new Promise((e, t) => {
...
}, vd = (i, e) => YS(k.isObject(i) ? i : { address: i, family: e }), ZS = VS && function(e) {
  return XS(async function(s, o, c) {
    ...
    let He;
    const Ln = KS.test(le.protocol);
    if (le.agent = Ln ? e.httpsAgent : e.httpAgent, e.transport ? He = e.transport : e.maxRedirects === 0 ? He = Ln ? Sc : Rc : (e.maxRedirects && (le.maxRedirects = e.maxRedirects), e.beforeRedirect && (le.beforeRedirects.config = e.beforeRedirect), He = Ln ? WS : GS), e.maxBodyLength > -1 ? le.maxBodyLength = e.maxBodyLength : le.maxBodyLength = 1 / 0, e.insecureHTTPParser && (le.insecureHTTPParser = e.insecureHTTPParser), _ = He.request(le, function(K) {
      ...
      if (e.decompress !== !1 && K.headers["content-encoding"])
        switch ((g === "HEAD" || K.statusCode === 204) && delete K.headers["content-encoding"], (K.headers["content-encoding"] || "").toLowerCase()) {
          ...
          case "x-compress":
            ...
            break;
          case "deflate":
            Me.push(new NS()), Me.push(dt.createUnzip(dd)), delete K.headers["content-encoding"];
            break;
          case "br":
            fd && (Me.push(dt.createBrotliDecompress(HS)), delete K.headers["content-encoding"]);
        }
...
}, tr = typeof fetch == "function" && typeof Request == "function" && typeof Response == "function", Im = tr && typeof ReadableStream == "function", ok = tr && (typeof TextEncoder == "function" ? /* @__PURE__ */ ((i) => (e) => i.encode(e))(new TextEncoder()) : async (i) => new Uint8Array(await new Response(i).arrayBuffer())), Lm = (i, ...e) => {
  try {
    return !!i(...e);
  } catch {
    return !1;
...
const yd = (i) => `- ${i}`, dk = (i) => k.isFunction(i) || i === null || i === !1, Fm = {
  getAdapter: (i) => {
    i = k.isArray(i) ? i : [i];
    const { length: e } = i;
    let t, s;
...
const {
  ...
  getAdapter: Pk,
  mergeConfig: Mk
} = de, Ik = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  Axios: xk,
  AxiosError: gk,
  AxiosHeaders: Tk,
...
function Zn(i) {
  return Array.isArray ? Array.isArray(i) : Bm(i) === "[object Array]";
}
const Qk = 1 / 0;
function eA(i) {
  if (typeof i == "string")
...
function tA(i) {
  return i === !0 || i === !1 || iA(i) && Bm(i) == "[object Boolean]";
}
function Nm(i) {
  ...
  const o = (c, l, p) => {
    if (on(c))
      if (!l[p])
        ...
        if (!on(m))
          return;
        if (p === l.length - 1 && (Dn(m) || Dm(m) || tA(m)))
          t.push(nA(m));
        else if (Zn(m)) {
          s = !0;
...
function zm(i, e, { getFn: t = Z.getFn, fieldNormWeight: s = Z.fieldNormWeight } = {}) {
  const o = new eu({ getFn: t, fieldNormWeight: s });
  return o.setKeys(i.map(Um)), o.setSources(e), o.create(), o;
}
...
class Gm extends ht {
  constructor(e, {
    ...
    super(e), this._bitapSearch = new Hm(e, {
      location: t,
      threshold: s,
      distance: o,
      includeMatches: c,
...
const OA = /* @__PURE__ */ new Set([Gm.type, Wm.type]);
class PA {
  constructor(e, {
...
const Ms = {
  ...
  PATH: "$path",
  PATTERN: "$val"
}, bc = (i) => !!(i[Ms.AND] || i[Ms.OR]), IA = (i) => !!i[gc.PATH], LA = (i) => !Zn(i) && Nm(i) && !bc(i), Ad = (i) => ({
  [Ms.AND]: Object.keys(i).map((e) => ({
    [e]: i[e]
  }))
});
function Km(i, e, { auto: t = !0 } = {}) {
  const s = (o) => {
    let c = Object.keys(o);
    const l = IA(o);
...
class ui {
  ...
  setCollection(e, t) {
    if (this._docs = e, t && !(t instanceof eu))
      throw new Error(aA);
    this._myIndex = t || zm(this.options.keys, this._docs, {
  ...
  search(e, { limit: t = -1 } = {}) {
    ...
    return FA(f, { ignoreFieldNorm: p }), c && f.sort(l), Dm(t) && t > -1 && (f = f.slice(0, t)), jA(f, this._docs, {
      includeMatches: s,
      includeScore: o
    });
  }
  ...
  _searchLogical(e) {
    const t = Km(e, this.options), s = (p, f, m) => {
      if (!p.children) {
...
(function(i, e) {
  (function() {
    var t, s = "4.17.21", o = 200, c = "Unsupported core-js use. Try https://npms.io/search?q=ponyfill.", l = "Expected a function", p = "Invalid `variable` option passed into `_.template`", f = "__lodash_hash_undefined__", m = 500, h = "__lodash_placeholder__", g = 1, y = 2, S = 4, _ = 1, O = 2, C = 1, F = 2, $ = 4, q = 8, G = 16, z = 32, te = 64, D = 128, H = 256, V = 512, Pe = 30, Fe = "...", Ne = 800, vt = 16, le = 1, He = 2, Ln = 3, W = 1 / 0, K = 9007199254740991, Me = 17976931348623157e292, dn = NaN, he = 4294967295, Fn = he - 1, li = he >>> 1, fn = [
      ...
      ["partialRight", te],
      ["rearg", H]
    ], Te = "[object Arguments]", xt = "[object Array]", pi = "[object AsyncFunction]", Se = "[object Boolean]", di = "[object Date]", nh = "[object DOMException]", na = "[object Error]", ta = "[object Function]", nu = "[object GeneratorFunction]", En = "[object Map]", fi = "[object Number]", th = "[object Null]", Un = "[object Object]", tu = "[object Promise]", ih = "[object Proxy]", mi = "[object RegExp]", Rn = "[object Set]", hi = "[object String]", ia = "[object Symbol]", ah = "[object Undefined]", vi = "[object WeakMap]", sh = "[object WeakSet]", xi = "[object ArrayBuffer]", $t = "[object DataView]", sr = "[object Float32Array]", rr = "[object Float64Array]", or = "[object Int8Array]", cr = "[object Int16Array]", ur = "[object Int32Array]", lr = "[object Uint8Array]", pr = "[object Uint8ClampedArray]", dr = "[object Uint16Array]", fr = "[object Uint32Array]", rh = /\b__p \+= '';/g, oh = /\b(__p \+=) '' \+/g, ch = /(__e\(.*?\)|\b__t\)) \+\n'';/g, iu = /&(?:amp|lt|gt|quot|#39);/g, au = /[&<>"']/g, uh = RegExp(iu.source), lh = RegExp(au.source), ph = /<%-([\s\S]+?)%>/g, dh = /<%([\s\S]+?)%>/g, su = /<%=([\s\S]+?)%>/g, fh = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, mh = /^\w*$/, hh = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, mr = /[\\^$.*+?()[\]{}|]/g, vh = RegExp(mr.source), hr = /^\s+/, xh = /\s/, gh = /\{(?:\n\/\* \[wrapped with .+\] \*\/)?\n?/, bh = /\{\n\/\* \[wrapped with (.+)\] \*/, yh = /,? & /, wh = /[^\x00-\x2f\x3a-\x40\x5b-\x60\x7b-\x7f]+/g, _h = /[()=,{}\[\]\/\s]/, Eh = /\\(\\)?/g, Rh = /\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g, ru = /\w*$/, Sh = /^[-+]0x[0-9a-f]+$/i, kh = /^0b[01]+$/i, Ah = /^\[object .+?Constructor\]$/, Th = /^0o[0-7]+$/i, Ch = /^(?:0|[1-9]\d*)$/, Oh = /[\xc0-\xd6\xd8-\xf6\xf8-\xff\u0100-\u017f]/g, aa = /($^)/, Ph = /['\n\r\u2028\u2029\\]/g, sa = "\\ud800-\\udfff", Mh = "\\u0300-\\u036f", Ih = "\\ufe20-\\ufe2f", Lh = "\\u20d0-\\u20ff", ou = Mh + Ih + Lh, cu = "\\u2700-\\u27bf", uu = "a-z\\xdf-\\xf6\\xf8-\\xff", Fh = "\\xac\\xb1\\xd7\\xf7", qh = "\\x00-\\x2f\\x3a-\\x40\\x5b-\\x60\\x7b-\\xbf", $h = "\\u2000-\\u206f", jh = " \\t\\x0b\\f\\xa0\\ufeff\\n\\r\\u2028\\u2029\\u1680\\u180e\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200a\\u202f\\u205f\\u3000", lu = "A-Z\\xc0-\\xd6\\xd8-\\xde", pu = "\\ufe0e\\ufe0f", du = Fh + qh + $h + jh, vr = "['’]", Dh = "[" + sa + "]", fu = "[" + du + "]", ra = "[" + ou + "]", mu = "\\d+", Nh = "[" + cu + "]", hu = "[" + uu + "]", vu = "[^" + sa + du + mu + cu + uu + lu + "]", xr = "\\ud83c[\\udffb-\\udfff]", Bh = "(?:" + ra + "|" + xr + ")", xu = "[^" + sa + "]", gr = "(?:\\ud83c[\\udde6-\\uddff]){2}", br = "[\\ud800-\\udbff][\\udc00-\\udfff]", jt = "[" + lu + "]", gu = "\\u200d", bu = "(?:" + hu + "|" + vu + ")", Uh = "(?:" + jt + "|" + vu + ")", yu = "(?:" + vr + "(?:d|ll|m|re|s|t|ve))?", wu = "(?:" + vr + "(?:D|LL|M|RE|S|T|VE))?", _u = Bh + "?", Eu = "[" + pu + "]?", zh = "(?:" + gu + "(?:" + [xu, gr, br].join("|") + ")" + Eu + _u + ")*", Hh = "\\d*(?:1st|2nd|3rd|(?![123])\\dth)(?=\\b|[A-Z_])", Gh = "\\d*(?:1ST|2ND|3RD|(?![123])\\dTH)(?=\\b|[a-z_])", Ru = Eu + _u + zh, Wh = "(?:" + [Nh, gr, br].join("|") + ")" + Ru, Kh = "(?:" + [xu + ra + "?", ra, gr, br, Dh].join("|") + ")", Jh = RegExp(vr, "g"), Vh = RegExp(ra, "g"), yr = RegExp(xr + "(?=" + xr + ")|" + Kh + Ru, "g"), Xh = RegExp([
      jt + "?" + hu + "+" + yu + "(?=" + [fu, jt, "$"].join("|") + ")",
      Uh + "+" + wu + "(?=" + [fu, jt + bu, "$"].join("|") + ")",
      jt + "?" + bu + "+" + yu,
      jt + "+" + wu,
      ...
      mu,
      Wh
    ].join("|"), "g"), Yh = RegExp("[" + gu + sa + ou + pu + "]"), Zh = /[a-z][A-Z]|[A-Z]{2}[a-z]|[0-9][a-zA-Z]|[a-zA-Z][0-9]|[^a-zA-Z0-9 ]/, Qh = [
      "Array",
      "Buffer",
      "DataView",
      "Date",
    ...
    be[sr] = be[rr] = be[or] = be[cr] = be[ur] = be[lr] = be[pr] = be[dr] = be[fr] = !0, be[Te] = be[xt] = be[xi] = be[Se] = be[$t] = be[di] = be[na] = be[ta] = be[En] = be[fi] = be[Un] = be[mi] = be[Rn] = be[hi] = be[vi] = !1;
    var xe = {};
    ...
    var nv = {
      ...
      "\u2028": "u2028",
      "\u2029": "u2029"
    }, sv = parseFloat, rv = parseInt, Su = typeof On == "object" && On && On.Object === Object && On, ov = typeof self == "object" && self && self.Object === Object && self, qe = Su || ov || Function("return this")(), wr = e && !e.nodeType && e, gt = wr && !0 && i && !i.nodeType && i, ku = gt && gt.exports === wr, _r = ku && Su.process, mn = function() {
      try {
    ...
    function Sn(E) {
      return Nt(E) ? Cv(E) : dv(E);
    }
    function Uu(E) {
      for (var P = E.length; P-- && xh.test(E.charAt(P)); )
        ;
      return P;
    }
    var Av = Ar(iv);
    ...
    var Pv = function E(P) {
      P = P == null ? qe : Ut.defaults(qe.Object(), P, Ut.pick(qe, Qh));
      var A = P.Array, B = P.Date, Q = P.Error, pe = P.Function, Ce = P.Math, ve = P.Object, Mr = P.RegExp, Mv = P.String, vn = P.TypeError, la = A.prototype, Iv = pe.prototype, zt = ve.prototype, pa = P["__core-js_shared__"], da = Iv.toString, me = zt.hasOwnProperty, Lv = 0, zu = function() {
        var n = /[^.]+$/.exec(pa && pa.keys && pa.keys.IE_PROTO || "");
        return n ? "Symbol(src)_1." + n : "";
      }(), fa = zt.toString, Fv = da.call(ve), qv = qe._, $v = Mr(
      ...
      }(), jv = P.clearTimeout !== qe.clearTimeout && P.clearTimeout, Dv = B && B.now !== qe.Date.now && B.now, Nv = P.setTimeout !== qe.setTimeout && P.setTimeout, ba = Ce.ceil, ya = Ce.floor, Ir = ve.getOwnPropertySymbols, Bv = ma ? ma.isBuffer : t, Ju = P.isFinite, Uv = la.join, zv = Bu(ve.keys, ve), Oe = Ce.max, Be = Ce.min, Hv = B.now, Gv = P.parseInt, Vu = Ce.random, Wv = la.reverse, Lr = Rt(P, "DataView"), yi = Rt(P, "Map"), Fr = Rt(P, "Promise"), Ht = Rt(P, "Set"), wi = Rt(P, "WeakMap"), _i = Rt(ve, "create"), wa = wi && new wi(), Gt = {}, Kv = St(Lr), Jv = St(yi), Vv = St(Fr), Xv = St(Ht), Yv = St(wi), _a = tt ? tt.prototype : t, Ei = _a ? _a.valueOf : t, Xu = _a ? _a.toString : t;
      function v(n) {
      ...
      function ex() {
        var n = this.__wrapped__.value(), a = this.__dir__, r = ee(n), u = a < 0, d = r ? n.length : 0, x = dg(0, d, this.__views__), b = x.start, w = x.end, R = w - b, M = u ? w : b - 1, I = this.__iteratees__, L = I.length, j = 0, U = Be(R, this.__takeCount__);
        if (!r || !u && d == R && U == R)
      ...
      yt.prototype.clear = nx, yt.prototype.delete = tx, yt.prototype.get = ix, yt.prototype.has = ax, yt.prototype.set = sx;
      function zn(n) {
        var a = -1, r = n == null ? 0 : n.length;
        for (this.clear(); ++a < r; ) {
          var u = n[a];
      ...
      zn.prototype.clear = rx, zn.prototype.delete = ox, zn.prototype.get = cx, zn.prototype.has = ux, zn.prototype.set = lx;
      function Hn(n) {
        var a = -1, r = n == null ? 0 : n.length;
        for (this.clear(); ++a < r; ) {
          var u = n[a];
      ...
      Hn.prototype.clear = px, Hn.prototype.delete = dx, Hn.prototype.get = fx, Hn.prototype.has = mx, Hn.prototype.set = hx;
      function wt(n) {
        var a = -1, r = n == null ? 0 : n.length;
      ...
      wt.prototype.add = wt.prototype.push = vx, wt.prototype.has = xx;
      function kn(n) {
      ...
      kn.prototype.clear = gx, kn.prototype.delete = bx, kn.prototype.get = yx, kn.prototype.has = wx, kn.prototype.set = _x;
      function Yu(n, a) {
        var r = ee(n), u = !r && kt(n), d = !r && !u && ot(n), x = !r && !u && !d && Xt(n), b = r || u || d || x, w = b ? Cr(n.length, Mv) : [], R = w.length;
        for (var M in n)
      ...
      function gn(n, a, r, u, d, x) {
        ...
        if (I) {
          ...
          if (L == Un || L == Te || j && !d) {
            if (b = R || j ? {} : Ul(n), !w)
              return R ? ig(n, kx(b, n)) : tg(n, Qu(b, n));
          } else {
            if (!xe[L])
              return d ? n : {};
            b = hg(n, L, w);
      ...
      function Ge(n) {
        return n == null ? n === t ? ah : th : bt && bt in ve(n) ? pg(n) : Rg(n);
      }
      function Nr(n, a) {
        return n > a;
      }
      ...
      function Ai(n, a, r, u, d) {
        return n === a ? !0 : n == null || a == null || !_e(n) && !_e(a) ? n !== n && a !== a : qx(n, a, r, u, Ai, d);
      }
      function qx(n, a, r, u, d, x) {
        ...
        if (j && !I)
          return x || (x = new kn()), b || Xt(n) ? Dl(n, a, r, u, d, x) : ug(n, a, R, r, u, d, x);
        if (!(r & _)) {
        ...
        return j ? (x || (x = new kn()), lg(n, a, r, u, d, x)) : !1;
      }
      function $x(n) {
        return _e(n) && Ue(n) == En;
      }
      ...
      function Nx(n) {
        return _e(n) && za(n.length) && !!be[Ge(n)];
      }
      function cl(n) {
      ...
      function Gr(n, a, r, u) {
        var d = u ? mv : Dt, x = -1, b = a.length, w = n;
      ...
      function Jt(n) {
        return function(a) {
          return Rr(Tp(Ap(a).replace(Jh, "")), n, "");
        };
      }
      function Ci(n) {
        return function() {
      ...
      function Pa(n, a, r, u, d, x, b, w, R, M) {
        ...
        function Y() {
          ...
          return se = oe.length, w ? oe = Sg(oe, w) : X && se > 1 && oe.reverse(), I && R < se && (oe.length = R), this && this !== qe && this instanceof Y && (Yn = ie || Ci(Yn)), Yn.apply(Tn, oe);
        }
        return Y;
      }
      function Il(n, a) {
      ...
      function Ll(n) {
        return function(a, r, u) {
          return u && typeof u != "number" && We(a, r, u) && (r = u = t), a = Xn(a), r === t ? (r = a, a = 0) : r = Xn(r), u = u === t ? a < r ? 1 : -1 : Xn(u), Gx(a, r, u, n);
        };
      }
      function La(n) {
        return function(a, r) {
      ...
      var og = Ht && 1 / ua(new Ht([, -0]))[1] == W ? function(n) {
        return new Ht(n);
      } : Ro;
      function ql(n) {
        return function(a) {
          var r = Ue(a);
          return r == En ? Pr(a) : r == Rn ? Rv(a) : vv(a, n(a));
        };
      }
      function Wn(n, a, r, u, d, x, b, w) {
        ...
        if (j && _g(U, j), n = U[0], a = U[1], r = U[2], u = U[3], d = U[4], w = U[9] = U[9] === t ? R ? 0 : n.length : Oe(U[9] - M, 0), !w && a & (q | G) && (a &= ~(q | G)), !a || a == C)
          var X = ag(n, a, r);
        else a == q || a == G ? X = sg(n, a, w) : (a == z || a == (C | z)) && !d.length ? X = rg(n, a, r, u) : X = Pa.apply(t, U);
        var ie = j ? vl : Kl;
      ...
      function qa(n, a) {
        var r = n.__data__;
        return gg(a) ? r[typeof a == "string" ? "string" : "hash"] : r.map;
      }
      function so(n) {
      ...
      function vg(n, a) {
        ...
        if (!r)
          return n;
        var u = r - 1;
        return a[u] = (r > 1 ? "& " : "") + a[u], a = a.join(r > 2 ? ", " : " "), n.replace(gh, `{
/* [wrapped with ` + a + `] */
`);
      }
      function xg(n) {
      ...
      function Jn(n, a) {
        var r = typeof n;
        return a = a ?? K, !!a && (r == "number" || r != "symbol" && Ch.test(n)) && n > -1 && n % 1 == 0 && n < a;
      }
      function We(n, a, r) {
        if (!we(r))
          return !1;
      ...
      function oo(n, a) {
        if (ee(n))
          return !1;
        var r = typeof n;
        return r == "number" || r == "symbol" || r == "boolean" || n == null || an(n) ? !0 : mh.test(n) || !fh.test(n) || a != null && n in ve(a);
      }
      function gg(n) {
        var a = typeof n;
      ...
      var Kl = Vl(vl), Pi = Nv || function(n, a) {
        return qe.setTimeout(n, a);
      }, lo = Vl(Jx);
      function Jl(n, a, r) {
        var u = a + "";
        return lo(n, vg(u, kg(fg(u), r)));
      }
      function Vl(n) {
        var a = 0, r = 0;
        return function() {
      ...
      var Xl = wg(function(n) {
        var a = [];
        return n.charCodeAt(0) === 46 && a.push(""), n.replace(hh, function(r, u, d, x) {
          a.push(d ? x.replace(Eh, "$1") : u || r);
        }), a;
      });
      function jn(n) {
      ...
      function $g(n, a, r, u) {
        ...
        return d ? (r && typeof r != "number" && We(n, a, r) && (r = 0, u = d), Cx(n, a, r, u)) : [];
      }
      function Zl(n, a, r) {
        var u = n == null ? 0 : n.length;
        if (!u)
      ...
      function Kg(n, a, r) {
        ...
        if (!u)
          return -1;
        var d = u;
        return r !== t && (d = ne(r), d = d < 0 ? Oe(u + d, 0) : Be(d, u - 1)), a === a ? kv(n, a, d) : ca(n, Fu, d, !0);
      }
      function Jg(n, a) {
      ...
      function Zb(n, a, r) {
        var u = ee(n) ? lv : $u, d = arguments.length < 3;
      ...
      var oy = ae(function(n, a) {
        return nl(n, 1, a);
      }), cy = ae(function(n, a, r) {
      ...
      function vo(n) {
        if (!_e(n))
          return !1;
        var a = Ge(n);
        return a == na || a == nh || typeof n.message == "string" && typeof n.name == "string" && !Mi(n);
      }
      function Iy(n) {
      ...
      function Mi(n) {
        ...
        return typeof r == "function" && r instanceof r && da.call(r) == Fv;
      }
      var xo = Ou ? nn(Ou) : jx;
      function Ny(n) {
        return mp(n) && n >= -K && n <= K;
      ...
      var Hy = La(Hr), Gy = La(function(n, a) {
        return n <= a;
      });
      function gp(n) {
        if (!n)
      ...
      function wn(n) {
        ...
        n = ju(n);
        var r = kh.test(n);
        return r || Th.test(n) ? rv(n.slice(2), r ? 2 : 8) : Sh.test(n) ? dn : +n;
      }
      function yp(n) {
        return $n(n, Xe(n));
      }
      ...
      function bo(n, a) {
        return n != null && Bl(n, a, Px);
      }
      var cw = Il(function(n, a, r) {
        a != null && typeof a.toString != "function" && (a = fa.call(a)), n[a] = r;
      }, wo(Ye)), uw = Il(function(n, a, r) {
      ...
      var vw = Kn(function(n, a) {
        return n == null ? {} : zx(n, a);
      });
      function Ep(n, a) {
        if (n == null)
          return {};
      ...
      function kw(n, a, r) {
        return a = Xn(a), r === t ? (r = a, a = 0) : r = Xn(r), n = wn(n), Mx(n, a, r);
      }
      function Aw(n, a, r) {
        ...
        if (r || n % 1 || a % 1) {
          var d = Vu();
          return Be(n + d * (a - n + sv("1e-" + ((d + "").length - 1))), a);
        }
        return Wr(n, a);
      }
      var Tw = Jt(function(n, a, r) {
      ...
      function Ap(n) {
        return n = fe(n), n && n.replace(Oh, gv).replace(Vh, "");
      }
      function Cw(n, a, r) {
        n = fe(n), a = tn(a);
        var u = n.length;
      ...
      function Ow(n) {
        return n = fe(n), n && lh.test(n) ? n.replace(au, bv) : n;
      }
      function Pw(n) {
        return n = fe(n), n && vh.test(n) ? n.replace(mr, "\\$&") : n;
      }
      var Mw = Jt(function(n, a, r) {
      ...
      function jw(n, a, r) {
        return r || a == null ? a = 0 : a && (a = +a), Gv(fe(n).replace(hr, ""), a || 0);
      }
      function Dw(n, a, r) {
      ...
      function Gw(n, a, r) {
        ...
        var d = Ga({}, a.imports, u.imports, $l), x = Ie(d), b = Or(d, x), w, R, M = 0, I = a.interpolate || aa, L = "__p += '", j = Mr(
          (a.escape || aa).source + "|" + I.source + "|" + (I === su ? Rh : aa).source + "|" + (a.evaluate || aa).source + "|$",
          "g"
        ), U = "//# sourceURL=" + (me.call(a, "sourceURL") ? (a.sourceURL + "").replace(/\s/g, " ") : "lodash.templateSources[" + ++ev + "]") + `
`;
        n.replace(j, function(Y, se, oe, sn, Ke, rn) {
          return oe || (oe = sn), L += n.slice(M, rn).replace(Ph, yv), se && (w = !0, L += `' +
__e(` + se + `) +
'`), Ke && (R = !0, L += `';
` + Ke + `;
__p += '`), oe && (L += `' +
...
`;
          ...
          throw new Q(p);
        L = (R ? L.replace(rh, "") : L).replace(oh, "$1").replace(ch, "$1;"), L = "function(" + (X || "obj") + `) {
` + (X ? "" : `obj || (obj = {});
...
`) + L + `return __p
      ...
      function Zw(n) {
        return n = fe(n), n && uh.test(n) ? n.replace(iu, Av) : n;
      }
      var Qw = Jt(function(n, a, r) {
        return n + (r ? " " : "") + a.toUpperCase();
      }), yo = Ol("toUpperCase");
      function Tp(n, a, r) {
        return n = fe(n), a = r ? t : a, a === t ? _v(n) ? Ov(n) : fv(n) : n.match(a) || [];
      }
      ...
      var d_ = eo(ye), f_ = eo(Iu), m_ = eo(Sr);
      function Op(n) {
        return oo(n) ? kr(jn(n)) : Hx(n);
      }
      function h_(n) {
        return function(a) {
      ...
      var R_ = Ma(function(n, a) {
        return n + a;
      }, 0), S_ = no("ceil"), k_ = Ma(function(n, a) {
        return n / a;
      }, 1), A_ = no("floor");
      function T_(n) {
      ...
      var L_ = Ma(function(n, a) {
        return n * a;
      }, 1), F_ = no("round"), q_ = Ma(function(n, a) {
        return n - a;
      }, 0);
      function $_(n) {
      ...
      return v.after = ry, v.ary = op, v.assign = Ky, v.assignIn = wp, v.assignInWith = Ga, v.assignWith = Jy, v.at = Vy, v.before = cp, v.bind = mo, v.bindAll = e_, v.bindKey = up, v.castArray = gy, v.chain = ap, v.chunk = Ag, v.compact = Tg, v.concat = Cg, v.cond = n_, v.conforms = t_, v.constant = wo, v.countBy = $b, v.create = Xy, v.curry = lp, v.curryRight = pp, v.debounce = dp, v.defaults = Yy, v.defaultsDeep = Zy, v.defer = oy, v.delay = cy, v.difference = Og, v.differenceBy = Pg, v.differenceWith = Mg, v.drop = Ig, v.dropRight = Lg, v.dropRightWhile = Fg, v.dropWhile = qg, v.fill = $g, v.filter = Db, v.flatMap = Ub, v.flatMapDeep = zb, v.flatMapDepth = Hb, v.flatten = ep, v.flattenDeep = jg, v.flattenDepth = Dg, v.flip = uy, v.flow = a_, v.flowRight = s_, v.fromPairs = Ng, v.functions = sw, v.functionsIn = rw, v.groupBy = Gb, v.initial = Ug, v.intersection = zg, v.intersectionBy = Hg, v.intersectionWith = Gg, v.invert = cw, v.invertBy = uw, v.invokeMap = Kb, v.iteratee = _o, v.keyBy = Jb, v.keys = Ie, v.keysIn = Xe, v.map = Da, v.mapKeys = pw, v.mapValues = dw, v.matches = r_, v.matchesProperty = o_, v.memoize = Ba, v.merge = fw, v.mergeWith = _p, v.method = c_, v.methodOf = u_, v.mixin = Eo, v.negate = Ua, v.nthArg = p_, v.omit = mw, v.omitBy = hw, v.once = ly, v.orderBy = Vb, v.over = d_, v.overArgs = py, v.overEvery = f_, v.overSome = m_, v.partial = ho, v.partialRight = fp, v.partition = Xb, v.pick = vw, v.pickBy = Ep, v.property = Op, v.propertyOf = h_, v.pull = Vg, v.pullAll = tp, v.pullAllBy = Xg, v.pullAllWith = Yg, v.pullAt = Zg, v.range = v_, v.rangeRight = x_, v.rearg = dy, v.reject = Qb, v.remove = Qg, v.rest = fy, v.reverse = po, v.sampleSize = ny, v.set = gw, v.setWith = bw, v.shuffle = ty, v.slice = eb, v.sortBy = sy, v.sortedUniq = ob, v.sortedUniqBy = cb, v.split = Uw, v.spread = my, v.tail = ub, v.take = lb, v.takeRight = pb, v.takeRightWhile = db, v.takeWhile = fb, v.tap = Tb, v.throttle = hy, v.thru = ja, v.toArray = gp, v.toPairs = Rp, v.toPairsIn = Sp, v.toPath = __, v.toPlainObject = yp, v.transform = yw, v.unary = vy, v.union = mb, v.unionBy = hb, v.unionWith = vb, v.uniq = xb, v.uniqBy = gb, v.uniqWith = bb, v.unset = ww, v.unzip = fo, v.unzipWith = ip, v.update = _w, v.updateWith = Ew, v.values = Yt, v.valuesIn = Rw, v.without = yb, v.words = Tp, v.wrap = xy, v.xor = wb, v.xorBy = _b, v.xorWith = Eb, v.zip = Rb, v.zipObject = Sb, v.zipObjectDeep = kb, v.zipWith = Ab, v.entries = Rp, v.entriesIn = Sp, v.extend = wp, v.extendWith = Ga, Eo(v, v), v.add = R_, v.attempt = Cp, v.camelCase = Tw, v.capitalize = kp, v.ceil = S_, v.clamp = Sw, v.clone = by, v.cloneDeep = wy, v.cloneDeepWith = _y, v.cloneWith = yy, v.conformsTo = Ey, v.deburr = Ap, v.defaultTo = i_, v.divide = k_, v.endsWith = Cw, v.eq = An, v.escape = Ow, v.escapeRegExp = Pw, v.every = jb, v.find = Nb, v.findIndex = Zl, v.findKey = Qy, v.findLast = Bb, v.findLastIndex = Ql, v.findLastKey = ew, v.floor = A_, v.forEach = sp, v.forEachRight = rp, v.forIn = nw, v.forInRight = tw, v.forOwn = iw, v.forOwnRight = aw, v.get = go, v.gt = Ry, v.gte = Sy, v.has = ow, v.hasIn = bo, v.head = np, v.identity = Ye, v.includes = Wb, v.indexOf = Bg, v.inRange = kw, v.invoke = lw, v.isArguments = kt, v.isArray = ee, v.isArrayBuffer = ky, v.isArrayLike = Ve, v.isArrayLikeObject = ke, v.isBoolean = Ay, v.isBuffer = ot, v.isDate = Ty, v.isElement = Cy, v.isEmpty = Oy, v.isEqual = Py, v.isEqualWith = My, v.isError = vo, v.isFinite = Iy, v.isFunction = Vn, v.isInteger = mp, v.isLength = za, v.isMap = hp, v.isMatch = Ly, v.isMatchWith = Fy, v.isNaN = qy, v.isNative = $y, v.isNil = Dy, v.isNull = jy, v.isNumber = vp, v.isObject = we, v.isObjectLike = _e, v.isPlainObject = Mi, v.isRegExp = xo, v.isSafeInteger = Ny, v.isSet = xp, v.isString = Ha, v.isSymbol = an, v.isTypedArray = Xt, v.isUndefined = By, v.isWeakMap = Uy, v.isWeakSet = zy, v.join = Wg, v.kebabCase = Mw, v.last = yn, v.lastIndexOf = Kg, v.lowerCase = Iw, v.lowerFirst = Lw, v.lt = Hy, v.lte = Gy, v.max = T_, v.maxBy = C_, v.mean = O_, v.meanBy = P_, v.min = M_, v.minBy = I_, v.stubArray = So, v.stubFalse = ko, v.stubObject = g_, v.stubString = b_, v.stubTrue = y_, v.multiply = L_, v.nth = Jg, v.noConflict = l_, v.noop = Ro, v.now = Na, v.pad = Fw, v.padEnd = qw, v.padStart = $w, v.parseInt = jw, v.random = Aw, v.reduce = Yb, v.reduceRight = Zb, v.repeat = Dw, v.replace = Nw, v.result = xw, v.round = F_, v.runInContext = E, v.sample = ey, v.size = iy, v.snakeCase = Bw, v.some = ay, v.sortedIndex = nb, v.sortedIndexBy = tb, v.sortedIndexOf = ib, v.sortedLastIndex = ab, v.sortedLastIndexBy = sb, v.sortedLastIndexOf = rb, v.startCase = zw, v.startsWith = Hw, v.subtract = q_, v.sum = $_, v.sumBy = j_, v.template = Gw, v.times = w_, v.toFinite = Xn, v.toInteger = ne, v.toLength = bp, v.toLower = Ww, v.toNumber = wn, v.toSafeInteger = Wy, v.toString = fe, v.toUpper = Kw, v.trim = Jw, v.trimEnd = Vw, v.trimStart = Xw, v.truncate = Yw, v.unescape = Zw, v.uniqueId = E_, v.upperCase = Qw, v.upperFirst = yo, v.each = sp, v.eachRight = rp, v.first = np, Eo(v, function() {
        var n = {};
        ...
        name: "wrapper",
        func: t
      }], re.prototype.clone = Zv, re.prototype.reverse = Qv, re.prototype.value = ex, v.prototype.at = Cb, v.prototype.chain = Ob, v.prototype.commit = Pb, v.prototype.next = Mb, v.prototype.plant = Lb, v.prototype.reverse = Fb, v.prototype.toJSON = v.prototype.valueOf = v.prototype.value = qb, v.prototype.first = v.prototype.head, bi && (v.prototype[bi] = Ib), v;
    }, Ut = Pv();
...
var Vm = On && On.__importDefault || function(i) {
  return i && i.__esModule ? i : { default: i };
};
Object.defineProperty(ir, "__esModule", { value: !0 });
ir.MovieDb = void 0;
const UA = Vm(DA), Fi = NA, zA = Vm(BA), T = ea;
class HA {
...
async function GA({ apiKey: i, playlistName: e }) {
  const t = new Jm.MovieDb(i), o = (await t.moviePopular({ language: "pt" })).results, c = await jm(e);
...
function WA({ path: i, startTime: e }, t) {
  ...
  return process.platform === "win32" ? s = Mp("C:/Program Files/VideoLAN (x86)/VLC/vlc.exe", o) : s = Mp("vlc", o), s.setMaxListeners(2), s.stderr.on("data", (c) => {
    const l = c.toString();
...
function XA(i) {
  ge.handle("get-metadata", qt), ge.handle("authenticate-user", async (e, t) => await $k(t)), ge.handle("fetch-tmdb-trending", async (e, t) => await GA(t)), ge.handle("update-vod", async (e, t) => await Lk(t)), ge.handle("update-series", async (e, t) => await Fk(t)), ge.handle("update-live", async (e, t) => await qk(t)), ge.handle("add-playlist-to-meta", async (e, t) => await jk(t)), ge.handle("edit-playlist-info", async (e, t) => await VA(t)), ge.handle("remove-playlist", async (e, t) => await Zk(t)), ge.handle("get-local-vod-playlist", async (e, t) => await jm(t)), ge.handle("get-local-series-playlist", async (e, t) => await Dk(t)), ge.handle("get-local-live-playlist", async (e, t) => await Nk(t)), ge.handle("get-playlist-info", async (e, t) => await Bk(t)), ge.handle("get-vod-info", async (e, t) => await Uk(t)), ge.handle("get-serie-info", async (e, t) => await zk(t)), ge.handle("get-user-data", async (e, t) => await Hk(t)), ge.handle("update-user-data", async (e, t) => await Gk(t)), ge.handle("change-current-playlist", async (e, t) => await Wk(t)), ge.handle("updated-at-playlist", async (e, t) => await Kk(t)), ge.handle("create-profile", async (e, t) => await Jk(t)), ge.handle("switch-profile", async (e, t) => await Vk(t)), ge.handle("rename-profile", async (e, t) => await Xk(t)), ge.handle("remove-profile", async (e, t) => await Yk(t)), ge.handle("launch-vlc", async (e, t) => WA(t, i)), ge.handle("get-vlc-state", async (e) => await KA()), ge.handle("kill-process", async (e, t) => JA(t));
}
...
function Xm() {
  return Pd || (Pd = 1, function(i, e) {
    e = i.exports = o.debug = o.default = o, e.coerce = f, e.disable = l, e.enable = c, e.enabled = p, e.humanize = YA(), e.names = [], e.skips = [], e.formatters = {};
    var t;
    function s(m) {
      var h = 0, g;
      for (g in m)
...
function ZA() {
  return Md || (Md = 1, function(i, e) {
    e = i.exports = Xm(), e.log = o, e.formatArgs = s, e.save = c, e.load = l, e.useColors = t, e.storage = typeof chrome < "u" && typeof chrome.storage < "u" ? chrome.storage.local : p(), e.colors = [
      "lightseagreen",
      "forestgreen",
      "goldenrod",
      "dodgerblue",
...
function QA() {
  return Id || (Id = 1, function(i, e) {
    var t = kc, s = Lt;
    e = i.exports = Xm(), e.init = y, e.log = f, e.formatArgs = p, e.save = m, e.load = h, e.useColors = l, e.colors = [6, 2, 3, 4, 5, 1], e.inspectOpts = Object.keys(process.env).filter(function(S) {
...
typeof process < "u" && process.type === "renderer" ? yc.exports = ZA() : yc.exports = QA();
var eT = yc.exports, wc = Re, nT = K_.spawn, Ym = eT("electron-squirrel-startup"), Xo = B_.app, Ld = function(i, e) {
  var t = wc.resolve(wc.dirname(process.execPath), "..", "Update.exe");
  Ym("Spawning `%s` with args `%s`", t, i), nT(t, i, {
    detached: !0
  }).on("close", e);
}, tT = function() {
  if (process.platform === "win32") {
    var i = process.argv[1];
    Ym("processing squirrel command `%s`", i);
...
const aT = /* @__PURE__ */ Ac(iT), Zm = pt.dirname(U_(import.meta.url));
process.env.APP_ROOT = pt.join(Zm, "..");
const _c = process.env.VITE_DEV_SERVER_URL, TT = pt.join(process.env.APP_ROOT, "dist-electron"), Qm = pt.join(process.env.APP_ROOT, "dist");
process.env.VITE_PUBLIC = _c ? pt.join(process.env.APP_ROOT, "public") : Qm;
let Ze;
aT && ti.quit();
function eh() {
  Ze = new Fd({
    ...
    webPreferences: {
      preload: pt.join(Zm, "preload.mjs"),
      nodeIntegration: !1,
      contextIsolation: !0,
      webSecurity: !1,
      spellcheck: !1
  ...
  }), _c ? Ze.loadURL(_c) : Ze.loadFile(pt.join(Qm, "index.html")), Ze.once("ready-to-show", () => {
    Ze == null || Ze.maximize();
  });
}
