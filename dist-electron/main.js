...
import D_, { app as ti, ipcMain as ge, BrowserWindow as Ld } from "electron";
import { fileURLToPath as N_ } from "node:url";
import pt from "node:path";
import Ft, { TextEncoder as B_ } from "util";
import Re from "path";
import Gi from "fs";
...
si.sync = o0;
si.async = c0;
const $s = Re, Nn = pn, Tc = qs, Mp = ze, Nd = si, u0 = (i, e, t) => {
...
In.async = v0;
In.createAsync = Oc;
const zd = Re, ii = pn, Ao = ze, Hd = In, x0 = (i, e, t, s) => {
...
qt.sync = b0;
qt.async = w0;
const Jd = pn, Vd = qt, To = ze, _0 = (i, e, t, s) => {
  const o = `${i}(path, data, [options])`;
...
Fs.async = R0;
var js = {};
const Ds = pn, Ic = qs, Pp = ze, Ns = qt, S0 = (i, e, t) => {
  const s = `${i}(path, [criteria])`;
...
js.async = P0;
var Bs = {}, Wi = {}, Bn = {};
const Zd = Ec, L0 = Re, ft = pn, Lp = ze, Zo = ["md5", "sha1", "sha256", "sha512"], Qo = ["report", "follow"], F0 = (i, e, t) => {
  ...
  parse(e, t) {
   ...
   %s`, D, D, _, o);
    ...
    for (let D = f.length - 1; D > -1; D--) {
      ...
      const De = o.slice(H.reEnd - 8, H.reEnd) + Fe, xt = V.split(")").length, ue = V.split("(").length - xt;
      let He = Fe;
      for (let W = 0; W < ue; W++)
        He = He.replace(/\)[+*?]?/, "");
      Fe = He;
...
const x1 = Re, ff = Wi, mf = Bn, hf = Mc, Dp = ze, g1 = (i, e, t) => {
  const s = `${i}([path], options)`;
...
Bs.async = _1;
var Hs = {};
const E1 = Ec, Rs = Re, Wa = Bn, Np = ze, yf = Wi, R1 = (i, e, t) => {
  const s = `${i}(path, [options])`;
...
ri.sync = I1;
ri.async = M1;
const Di = Re, cn = pn, qc = In, Ss = ri, _f = Bn, P1 = qt, L1 = Mc, Ef = qs, Rf = Wi, Mo = ze, F1 = (i, e, t, s) => {
...
Ki.async = W1;
var Ji = {};
const Tf = Re, ni = pn, Po = ze, Cf = Ki, Of = In, Ni = ri, ks = si, K1 = (i, e, t, s) => {
  const o = `${i}(from, to, [options])`;
...
Ji.async = X1;
var Ks = {};
const Lf = pn, Bp = ze, Up = ["utf8", "buffer", "json", "jsonWithDates"], Y1 = (i, e, t) => {
...
Ks.async = Q1;
var Js = {};
const Bi = Re, $f = Ji, Lo = ze, eE = (i, e, t, s) => {
...
Js.async = tE;
var Vs = {};
const jf = Re, As = pn, zp = ze, Df = In, iE = (i, e, t) => {
...
var Xs = {};
const jc = Re, rE = Fd, Bf = Ec, Uf = In, zf = pn, oE = ze, cE = (i, e) => {
  const t = `${i}([options])`;
...
Xs.sync = uE;
Xs.async = lE;
const Hp = Ft, Fo = Re, Ka = Fs, Ja = In, Va = js, Xa = Bs, Ya = Bn, Za = Hs, Qa = Ki, es = ri, ns = Us, ts = Ji, is = Ks, as = si, ss = Js, rs = Vs, Gp = $c, os = Xs, cs = qt, Wf = (i) => {
...
const dE = pE;
var fe = dE();
const oi = ti.getPath("sessionData"), fE = Re.join(oi, "Playlists"), Ue = Re.join(fE, "meta.json"), mE = (i) => Re.join(oi, `Playlists/${i}`), Mt = (i, e) => Re.join(oi, `Playlists/${i}/user/${e}.json`), Kf = (i) => Re.join(oi, `Playlists/${i}/vod.json`), Jf = (i) => Re.join(oi, `Playlists/${i}/series.json`), Vf = (i) => Re.join(oi, `Playlists/${i}/live.json`);
async function ht() {
  const i = await fe.readAsync(Ue, "json");
  if (!i) {
    const e = { isFirstTime: !0, currentPlaylist: { name: "", profile: "" }, playlists: [] };
    return await fe.writeAsync(Ue, e), e;
  }
  return i;
}
function Xf(i, e) {
...
const Ct = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : global, em = (i) => !Ui(i) && i !== Ct;
function ic() {
...
const XE = (i) => {
  ...
  return t(i, 0);
}, YE = Mn("AsyncFunction"), ZE = (i) => i && (Qs(i) || ln(i)) && ln(i.then) && ln(i.catch), im = ((i, e) => i ? setImmediate : e ? ((t, s) => (Ct.addEventListener("message", ({ source: o, data: c }) => {
  o === Ct && c === t && s.length && s.shift()();
}, !1), (o) => {
  s.push(o), Ct.postMessage(t, "*");
}))(`axios@${Math.random()}`, []) : (t) => setTimeout(t))(
  typeof setImmediate == "function",
  ln(Ct.postMessage)
), QE = typeof queueMicrotask < "u" ? queueMicrotask.bind(Ct) : typeof process < "u" && process.nextTick || im, k = {
  isArray: ci,
  isArrayBuffer: Yf,
  isBuffer: vE,
  isFormData: SE,
...
}, Nc = iR, MR = Ft, $o = Re, PR = Rc, LR = Sc, FR = Ls.parse, qR = Gi, $R = _n.Stream, jo = cm, jR = OR, ac = IR, DR = ce;
MR.inherits(ce, Nc);
function ce(i) {
...
(function() {
  var e = typeof process < "u", t = typeof window < "u" && typeof document < "u", s = Pt(Error.captureStackTrace);
...
Qe.prototype.end = function(i, e, t) {
  if (Pt(i) ? (t = i, i = e = null) : Pt(e) && (t = e, e = null), !i)
...
Qe.prototype._processResponse = function(i) {
  ...
  if (Em("redirecting to", h.href), this._isRedirect = !0, uc(h, this._options), (h.protocol !== p.protocol && h.protocol !== "https:" || h.host !== f && !TS(h.host, f)) && Go(/^(?:(?:proxy-)?authorization|cookie)$/i, this._options.headers), Pt(o)) {
    var g = {
      headers: i.headers,
      statusCode: e
    }, y = {
...
function Rm(i) {
  ...
  return Object.keys(i).forEach(function(s) {
    ...
    function p(m, h, g) {
      return OS(m) ? m = uc(m) : Ot(m) ? m = uc(Yc(m)) : (g = h, h = km(m), m = { protocol: o }), Pt(h) && (g = h, h = null), h = Object.assign({
        maxRedirects: e.maxRedirects,
        maxBodyLength: e.maxBodyLength
      }, m, h), h.nativeProtocols = t, !Ot(h.host) && !Ot(h.hostname) && (h.hostname = "::1"), Kc.equal(h.protocol, o, "protocol mismatch"), Em("options", h), new Qe(h, g);
    }
    function f(m, h, g) {
...
function Yc(i) {
  ...
  if (Jc)
    e = new zi(i);
  else if (e = km(Yi.parse(i)), !Ot(e.protocol))
...
function Zi(i, e, t) {
  function s(o) {
    Pt(Error.captureStackTrace) && Error.captureStackTrace(this, this.constructor), Object.assign(this, o || {}), this.code = i, this.message = this.cause ? e + ": " + this.cause.message : e;
  }
...
const VS = typeof process < "u" && k.kindOf(process) === "process", XS = (i) => new Promise((e, t) => {
  ...
  return XS(async function(s, o, c) {
    ...
    if (ue.agent = Ln ? e.httpsAgent : e.httpAgent, e.transport ? He = e.transport : e.maxRedirects === 0 ? He = Ln ? Sc : Rc : (e.maxRedirects && (ue.maxRedirects = e.maxRedirects), e.beforeRedirect && (ue.beforeRedirects.config = e.beforeRedirect), He = Ln ? WS : GS), e.maxBodyLength > -1 ? ue.maxBodyLength = e.maxBodyLength : ue.maxBodyLength = 1 / 0, e.insecureHTTPParser && (ue.insecureHTTPParser = e.insecureHTTPParser), _ = He.request(ue, function(K) {
      ...
      if (m === "stream")
        ...
        he.on("data", function(Se) {
          Te.push(Se), gt += Se.length, e.maxContentLength > -1 && gt > e.maxContentLength && (S = !0, he.destroy(), o(new N(
...
function Fm(i) {
  const e = new It(i), t = Xf(It.prototype.request, e);
  return k.extend(t, It.prototype, e, { allOwnKeys: !0 }), k.extend(t, e, null, { allOwnKeys: !0 }), t.create = function(o) {
    return Fm(Lt(i, o));
  }, t;
}
const pe = Fm(Xi);
...
async function jk(i) {
  const e = await fe.readAsync(Ue, "json");
  if (e.playlists) {
  ...
  return e.currentPlaylist = {
    name: i.name,
    profile: "Default"
  }, await fe.writeAsync(Ue, e);
}
async function qm(i) {
  const e = Kf(i);
  return await fe.readAsync(e, "json");
}
async function Dk(i) {
  return await fe.readAsync(Jf(i), "json");
}
async function Nk(i) {
  return await fe.readAsync(Vf(i), "json");
}
async function Bk(i) {
  return (await fe.readAsync(Ue, "json")).playlists.find((t) => t.name == i);
}
async function Uk(i) {
  if (!i) return;
  const e = await pe.get(i);
...
async function Hk(i) {
  const { currentPlaylist: e } = await ht(), t = Mt(e.name, i);
  let s = await fe.readAsync(Mt(e.name, i), "json");
  return s || (s = { vod: [], series: [], live: [] }, await fe.writeAsync(t, s)), s;
}
async function Gk(i) {
  const { currentPlaylist: e } = await ht(), t = Mt(e.name, e.profile);
  return await fe.writeAsync(t, i), i;
}
async function Wk(i) {
  const e = await fe.readAsync(Ue, "json"), t = e.playlists.find((s) => s.name == i);
  return t ? (e.currentPlaylist = {
    name: i,
    profile: t.profiles[0]
  }, await fe.writeAsync(Ue, e), !0) : !1;
}
async function Kk(i) {
  const e = await fe.readAsync(Ue, "json"), t = e.playlists.map((s) => (s.name == i && (s.updatedAt = /* @__PURE__ */ new Date()), s));
  return e.playlists = t, await fe.writeAsync(Ue, e);
}
async function Jk(i) {
  const e = await ht(), t = Mt(e.currentPlaylist.name, i), s = e.playlists.find((p) => p.name === e.currentPlaylist.name);
  ...
  e.playlists = c, await fe.writeAsync(Ue, e);
  let l = await fe.readAsync(Mt(e.currentPlaylist.name, i), "json");
  return l ? !1 : (l = { vod: [], series: [], live: [] }, await fe.writeAsync(t, l), !0);
}
async function Vk(i) {
  const e = await fe.readAsync(Ue, "json");
  return e.currentPlaylist.profile = i, await fe.writeAsync(Ue, e), !0;
}
async function Xk({ profile: i, newName: e }) {
  const t = await ht(), s = Mt(t.currentPlaylist.name, i);
  ...
  return t.playlists = o, await fe.writeAsync(Ue, t), await fe.renameAsync(s, `${e}.json`);
}
async function Yk(i) {
  const e = await ht();
  let t = [];
  ...
  e.currentPlaylist.profile = t[0], e.playlists = s, await fe.writeAsync(Ue, e);
  const o = Mt(e.currentPlaylist.name, i);
  await fe.removeAsync(o);
}
async function Zk(i) {
  const e = await ht();
  if (e.playlists) {
  ...
  return e.playlists.length === 0 ? e.currentPlaylist = {
    ...
    profile: "Default"
  }, await fe.removeAsync(mE(i)), await fe.writeAsync(Ue, e), e;
}
function Zn(i) {
...
function bA(i, e, t, {
  ...
  for (let D = 0; D < h; D += 1) {
    ...
    for (let ue = Fe; ue >= Ie; ue -= 1) {
      let He = ue - 1, Ln = t[i.charAt(He)];
      if (O && (C[He] = +!!Ln), De[ue] = (De[ue + 1] << 1 | 1) & Ln, D && (De[ue] |= ($[ue + 1] | $[ue]) << 1 | 1 | $[ue + 1]), De[ue] & z && (q = ds(e, {
        errors: D,
        currentLocation: He,
        expectedLocation: y,
        distance: o,
...
class Um {
  constructor(e, {
    ...
    if (g > Tt) {
      ...
      const S = g % Tt, _ = g - S;
      for (; y < _; )
        h(this.pattern.substr(y, Tt), y), y += Tt;
      if (S) {
        const O = g - Tt;
...
(function(i, e) {
  (function() {
    var t, s = "4.17.21", o = 200, c = "Unsupported core-js use. Try https://npms.io/search?q=ponyfill.", l = "Expected a function", p = "Invalid `variable` option passed into `_.template`", f = "__lodash_hash_undefined__", m = 500, h = "__lodash_placeholder__", g = 1, y = 2, S = 4, _ = 1, O = 2, C = 1, F = 2, $ = 4, q = 8, G = 16, z = 32, te = 64, D = 128, H = 256, V = 512, Ie = 30, Fe = "...", De = 800, xt = 16, ue = 1, He = 2, Ln = 3, W = 1 / 0, K = 9007199254740991, Me = 17976931348623157e292, dn = NaN, he = 4294967295, Fn = he - 1, li = he >>> 1, fn = [
      ["ary", D],
      ["bind", C],
      ["bindKey", F],
      ["curry", q],
    ...
    be[sr] = be[rr] = be[or] = be[cr] = be[ur] = be[lr] = be[pr] = be[dr] = be[fr] = !0, be[Te] = be[gt] = be[xi] = be[Se] = be[$t] = be[di] = be[na] = be[ta] = be[En] = be[fi] = be[Un] = be[mi] = be[Rn] = be[hi] = be[vi] = !1;
    var xe = {};
    xe[Te] = xe[gt] = xe[xi] = xe[$t] = xe[Se] = xe[di] = xe[sr] = xe[rr] = xe[or] = xe[cr] = xe[ur] = xe[En] = xe[fi] = xe[Un] = xe[mi] = xe[Rn] = xe[hi] = xe[ia] = xe[lr] = xe[pr] = xe[dr] = xe[fr] = !0, xe[na] = xe[ta] = xe[vi] = !1;
    var Qh = {
      ...
      "\u2028": "u2028",
      "\u2029": "u2029"
    }, iv = parseFloat, av = parseInt, Su = typeof On == "object" && On && On.Object === Object && On, sv = typeof self == "object" && self && self.Object === Object && self, qe = Su || sv || Function("return this")(), wr = e && !e.nodeType && e, bt = wr && !0 && i && !i.nodeType && i, ku = bt && bt.exports === wr, _r = ku && Su.process, mn = function() {
      try {
    ...
    var Cv = function E(I) {
      ...
      var A = I.Array, B = I.Date, Q = I.Error, le = I.Function, Ce = I.Math, ve = I.Object, Mr = I.RegExp, Ov = I.String, vn = I.TypeError, la = A.prototype, Iv = le.prototype, zt = ve.prototype, pa = I["__core-js_shared__"], da = Iv.toString, me = zt.hasOwnProperty, Mv = 0, zu = function() {
      ...
      ), ma = ku ? I.Buffer : t, tt = I.Symbol, ha = I.Uint8Array, Hu = ma ? ma.allocUnsafe : t, va = Bu(ve.getPrototypeOf, ve), Gu = ve.create, Wu = zt.propertyIsEnumerable, xa = la.splice, Ku = tt ? tt.isConcatSpreadable : t, bi = tt ? tt.iterator : t, yt = tt ? tt.toStringTag : t, ga = function() {
        try {
          var n = St(ve, "defineProperty");
          return n({}, "", {}), n;
        } catch {
        }
      }(), qv = I.clearTimeout !== qe.clearTimeout && I.clearTimeout, $v = B && B.now !== qe.Date.now && B.now, jv = I.setTimeout !== qe.setTimeout && I.setTimeout, ba = Ce.ceil, ya = Ce.floor, Pr = ve.getOwnPropertySymbols, Dv = ma ? ma.isBuffer : t, Ju = I.isFinite, Nv = la.join, Bv = Bu(ve.keys, ve), Oe = Ce.max, Ne = Ce.min, Uv = B.now, zv = I.parseInt, Vu = Ce.random, Hv = la.reverse, Lr = St(I, "DataView"), yi = St(I, "Map"), Fr = St(I, "Promise"), Ht = St(I, "Set"), wi = St(I, "WeakMap"), _i = St(ve, "create"), wa = wi && new wi(), Gt = {}, Gv = kt(Lr), Wv = kt(yi), Kv = kt(Fr), Jv = kt(Ht), Vv = kt(wi), _a = tt ? tt.prototype : t, Ei = _a ? _a.valueOf : t, Xu = _a ? _a.toString : t;
      function v(n) {
      ...
      wt.prototype.clear = Qv, wt.prototype.delete = ex, wt.prototype.get = nx, wt.prototype.has = tx, wt.prototype.set = ix;
      function zn(n) {
        var a = -1, r = n == null ? 0 : n.length;
        for (this.clear(); ++a < r; ) {
          var u = n[a];
      ...
      _t.prototype.add = _t.prototype.push = mx, _t.prototype.has = hx;
      function kn(n) {
      ...
      function Yu(n, a) {
        var r = ee(n), u = !r && At(n), d = !r && !u && ot(n), x = !r && !u && !d && Xt(n), b = r || u || d || x, w = b ? Cr(n.length, Ov) : [], R = w.length;
        for (var M in n)
      ...
      function Si(n, a, r, u) {
        ...
        if (!w)
          return R;
        r && (a = ye(a, nn(r))), u ? (x = Er, b = !1) : a.length >= o && (x = gi, b = !1, a = new _t(a));
        e:
          for (; ++d < w; ) {
      ...
      function Ge(n) {
        return n == null ? n === t ? th : eh : yt && yt in ve(n) ? ug(n) : _g(n);
      }
      function Nr(n, a) {
        return n > a;
      }
      ...
      function Br(n, a, r) {
        for (var u = r ? Er : oa, d = n[0].length, x = n.length, b = x, w = A(x), R = 1 / 0, M = []; b--; ) {
          var P = n[b];
          b && a && (P = ye(P, nn(a))), R = Ne(P.length, R), w[b] = !r && (a || d >= 120 && P.length >= 120) ? new _t(b && P) : t;
        }
        P = n[0];
        var L = -1, j = w[0];
        e:
      ...
      function Lx(n, a, r, u, d, x) {
        var b = ee(n), w = ee(a), R = b ? gt : Be(n), M = w ? gt : Be(a);
      ...
      function Nx(n, a, r, u, d, x, b) {
        ...
        if (L) {
          ...
          P = R, j || U || X ? ee(w) ? P = w : ke(w) ? P = Je(w) : U ? (L = !1, P = El(R, !0)) : X ? (L = !1, P = Rl(R, !0)) : P = [] : Mi(R) || At(R) ? (P = w, At(w) ? P = yp(w) : (!we(w) || Vn(w)) && (P = Ul(R))) : L = !1;
        }
      ...
      function Ll(n) {
        return function(a, r, u) {
          return u && typeof u != "number" && We(a, r, u) && (r = u = t), a = Xn(a), r === t ? (r = a, a = 0) : r = Xn(r), u = u === t ? a < r ? 1 : -1 : Xn(u), zx(a, r, u, n);
        };
      }
      function La(n) {
        return function(a, r) {
      ...
      function ug(n) {
        ...
        var d = fa.call(n);
        return u && (a ? n[yt] = r : delete n[yt]), d;
      }
      ...
      (Lr && Be(new Lr(new ArrayBuffer(1))) != $t || yi && Be(new yi()) != En || Fr && Be(Fr.resolve()) != tu || Ht && Be(new Ht()) != Rn || wi && Be(new wi()) != vi) && (Be = function(n) {
        var a = Ge(n), r = a == Un ? n.constructor : t, u = r ? kt(r) : "";
        if (u)
          switch (u) {
            case Gv:
              return $t;
      ...
      function Bl(n, a, r) {
        ...
        return x || ++u != d ? x : (d = n == null ? 0 : n.length, !!d && za(d) && Jn(b, d) && (ee(n) || At(n)));
      }
      function dg(n) {
...
`);
      ...
      function Wl(n, a) {
        return a.length < 2 ? n : Rt(n, bn(a, 0, -1));
      }
      function Eg(n, a) {
      ...
      function Fg(n, a, r, u) {
        ...
        return d ? (r && typeof r != "number" && We(n, a, r) && (r = 0, u = d), Ax(n, a, r, u)) : [];
      }
      function Zl(n, a, r) {
        var u = n == null ? 0 : n.length;
        if (!u)
      ...
      function Ty(n) {
        if (n == null)
          return !0;
        if (Ve(n) && (ee(n) || typeof n == "string" || typeof n.splice == "function" || ot(n) || Xt(n) || At(n)))
          return !n.length;
        var a = Be(n);
        if (a == En || a == Rn)
          return !n.size;
      ...
      function Ew(n, a, r) {
        return r === t && (r = a, a = t), r !== t && (r = wn(r), r = r === r ? r : 0), a !== t && (a = wn(a), a = a === a ? a : 0), Et(wn(n), a, r);
      }
      function Rw(n, a, r) {
      ...
      function $w(n, a, r) {
        return (r ? We(n, a, r) : a === t) ? a = 1 : a = ne(a), Kr(de(n), a);
      }
      function jw() {
      ...
      function Nw(n, a, r) {
        return r && typeof r != "number" && We(n, a, r) && (a = r = t), r = r === t ? he : r >>> 0, r ? (n = de(n), n && (typeof a == "string" || a != null && !xo(a)) && (a = tn(a), !a && Nt(n)) ? rt(Sn(n), 0, r) : n.split(a, r)) : [];
      }
      var Bw = Jt(function(n, a, r) {
        return n + (r ? " " : "") + yo(a);
      });
      function Uw(n, a, r) {
        return n = de(n), r = r == null ? 0 : Et(ne(r), 0, n.length), a = tn(a), n.slice(r, r + a.length) == a;
      }
      function zw(n, a, r) {
        var u = v.templateSettings;
        r && We(n, a, r) && (a = t), n = de(n), a = Ga({}, a, u, $l);
        var d = Ga({}, a.imports, u.imports, $l), x = Pe(d), b = Or(d, x), w, R, M = 0, P = a.interpolate || aa, L = "__p += '", j = Mr(
          ...
          "g"
        ), U = "//# sourceURL=" + (me.call(a, "sourceURL") ? (a.sourceURL + "").replace(/\s/g, " ") : "lodash.templateSources[" + ++Zh + "]") + `
`;
...
`) + L + `return __p
    ...
    bt ? ((bt.exports = Ut)._ = Ut, wr._ = Ut) : qe._ = Ut;
  }).call(On);
})(Ps, Ps.exports);
var NA = Ps.exports;
function Qi(i) {
...
var eT = yc.exports, wc = Re, nT = G_.spawn, Vm = eT("electron-squirrel-startup"), Xo = D_.app, Pd = function(i, e) {
...
const aT = /* @__PURE__ */ Ac(iT), Xm = pt.dirname(N_(import.meta.url));
