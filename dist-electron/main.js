...
import N_, { app as ti, ipcMain as ge, BrowserWindow as Ld } from "electron";
...
import W_, { spawn as K_ } from "child_process";
import J_ from "net";
...
si.sync = c0;
si.async = u0;
const $s = Re, Nn = pn, Tc = qs, Mp = ze, Nd = si, l0 = (i, e, t) => {
...
In.async = x0;
In.createAsync = Oc;
const zd = Re, ii = pn, Ao = ze, Hd = In, g0 = (i, e, t, s) => {
...
Ft.sync = y0;
Ft.async = _0;
const Jd = pn, Vd = Ft, To = ze, E0 = (i, e, t, s) => {
  const o = `${i}(path, data, [options])`;
...
Fs.async = S0;
var js = {};
const Ds = pn, Ic = qs, Pp = ze, Ns = Ft, k0 = (i, e, t) => {
  const s = `${i}(path, [criteria])`;
  ...
  const o = Xd(e);
  I0(i).then((c) => c !== void 0 ? M0(i, c, o) : P0(i, o)).then(t, s);
});
js.validateInput = k0;
js.sync = O0;
js.async = L0;
var Bs = {}, Wi = {}, Bn = {};
const Zd = Ec, F0 = Re, ft = pn, Lp = ze, Zo = ["md5", "sha1", "sha256", "sha512"], Qo = ["report", "follow"], q0 = (i, e, t) => {
...
var af = Z0, Q0 = t1, sf = "\0SLASH" + Math.random() + "\0", rf = "\0OPEN" + Math.random() + "\0", Pc = "\0CLOSE" + Math.random() + "\0", of = "\0COMMA" + Math.random() + "\0", cf = "\0PERIOD" + Math.random() + "\0";
function Co(i) {
...
function qi(i, e) {
  ...
  if (/\$$/.test(s.pre))
    ...
    if (h)
      y = s.body.split(/\.\./);
    else if (y = uf(s.body), y.length === 1 && (y = qi(y[0], !1).map(i1), y.length === 1))
...
const o1 = Q0, qp = {
  ...
  "*": { open: "(?:", close: ")*" },
  "@": { open: "(?:", close: ")" }
}, nc = "[^/]", Oo = nc + "*?", c1 = "(?:(?!(?:\\/|^)(?:\\.{1,2})($|\\/)).)*?", u1 = "(?:(?!(?:\\/|^)\\.).)*?", pf = (i) => i.split("").reduce((e, t) => (e[t] = !0, e), {}), $p = pf("().*{}+?[]^$\\!"), l1 = pf("[.("), jp = /\/+/;
...
const df = (i, e = {}) => (Es(i), e.nobrace || !/\{(?:(?!\{).)*\}/.test(i) ? [i] : o1(i)), p1 = 1024 * 64, Es = (i) => {
  if (typeof i != "string")
...
const g1 = Re, ff = Wi, mf = Bn, hf = Mc, Dp = ze, b1 = (i, e, t) => {
  const s = `${i}([path], options)`;
...
}, xf = (i, e) => i.map((t) => g1.relative(e, t)), gf = (i) => {
...
}), E1 = (i, e) => mf.async(i, { symlinks: "follow" }).then((t) => {
  if (t === void 0)
    throw gf(i);
  if (t.type !== "dir")
    throw bf(i);
...
Bs.async = E1;
var Hs = {};
const R1 = Ec, Rs = Re, Wa = Bn, Np = ze, yf = Wi, S1 = (i, e, t) => {
  const s = `${i}(path, [options])`;
...
ri.sync = M1;
ri.async = P1;
const Di = Re, cn = pn, qc = In, Ss = ri, _f = Bn, L1 = Ft, F1 = Mc, Ef = qs, Rf = Wi, Mo = ze, q1 = (i, e, t, s) => {
  ...
  times: !0,
  absolutePath: !0
}, Af = (i) => typeof i.opts.overwrite != "function" && i.opts.overwrite !== !0, $1 = (i, e, t) => {
  if (!Ss.sync(i))
    throw kf(i);
  ...
  const s = Sf(t, i);
  $1(i, e, s), Rf.sync(i, { inspectOptions: Ws }, (o, c) => {
...
Ki.async = K1;
var Ji = {};
const Tf = Re, ni = pn, Po = ze, Cf = Ki, Of = In, Ni = ri, ks = si, J1 = (i, e, t, s) => {
  const o = `${i}(from, to, [options])`;
    ...
    Ni.async(e).then((l) => {
      l !== !1 && s.overwrite !== !0 ? c(Mf(e)) : ni.rename(i, e).then(o).catch((p) => {
        p.code === "EISDIR" || p.code === "EPERM" ? ks.async(e).then(() => ni.rename(i, e)).then(o, c) : p.code === "EXDEV" ? Cf.async(i, e, { overwrite: !0 }).then(() => ks.async(i)).then(o, c) : p.code === "ENOENT" ? Ni.async(i).then((f) => {
          f ? X1(e).then(() => ni.rename(i, e)).then(o, c) : c(Pf(i));
        }).catch(c) : c(p);
      });
    });
  });
...
Ji.async = Y1;
var Ks = {};
const Lf = pn, Bp = ze, Up = ["utf8", "buffer", "json", "jsonWithDates"], Z1 = (i, e, t) => {
...
Ks.async = eE;
var Js = {};
const Bi = Re, $f = Ji, Lo = ze, nE = (i, e, t, s) => {
...
Js.async = iE;
var Vs = {};
const jf = Re, As = pn, zp = ze, Df = In, aE = (i, e, t) => {
...
var Xs = {};
const jc = Re, oE = Fd, Bf = Ec, Uf = In, zf = pn, cE = ze, uE = (i, e) => {
  const t = `${i}([options])`;
...
const fE = dE;
var ue = fE();
const oi = ti.getPath("sessionData"), mE = Re.join(oi, "Playlists"), De = Re.join(mE, "meta.json"), Kf = (i) => Re.join(oi, `Playlists/${i}`), It = (i, e) => Re.join(oi, `Playlists/${i}/user/${e}.json`), Jf = (i) => Re.join(oi, `Playlists/${i}/vod.json`), Vf = (i) => Re.join(oi, `Playlists/${i}/series.json`), Xf = (i) => Re.join(oi, `Playlists/${i}/live.json`);
async function qt() {
...
const Zf = Mn("ArrayBuffer");
function xE(i) {
  let e;
  return typeof ArrayBuffer < "u" && ArrayBuffer.isView ? e = ArrayBuffer.isView(i) : e = i && i.buffer && Zf(i.buffer), e;
}
const gE = Zs("string"), ln = Zs("function"), Qf = Zs("number"), Qs = (i) => i !== null && typeof i == "object", bE = (i) => i === !0 || i === !1, vs = (i) => {
  if (Ys(i) !== "object")
    return !1;
  const e = Dc(i);
...
const Tt = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : global, nm = (i) => !Ui(i) && i !== Tt;
function ic() {
  const { caseless: i } = nm(this) && this || {}, e = {}, t = (s, o) => {
    const c = i && em(e, o) || o;
...
), Wp = (({ hasOwnProperty: i }) => (e, t) => i.call(e, t))(Object.prototype), zE = Mn("RegExp"), tm = (i, e) => {
...
}, KE = (i, e) => i != null && Number.isFinite(i = +i) ? i : e, qo = "abcdefghijklmnopqrstuvwxyz", Kp = "0123456789", im = {
  DIGIT: Kp,
  ALPHA: qo,
  ALPHA_DIGIT: qo + qo.toUpperCase() + Kp
}, JE = (i = 16, e = im.ALPHA_DIGIT) => {
  let t = "";
  const { length: s } = e;
  for (; i--; )
    t += e[Math.random() * s | 0];
...
const XE = (i) => {
  ...
  return t(i, 0);
}, YE = Mn("AsyncFunction"), ZE = (i) => i && (Qs(i) || ln(i)) && ln(i.then) && ln(i.catch), am = ((i, e) => i ? setImmediate : e ? ((t, s) => (Tt.addEventListener("message", ({ source: o, data: c }) => {
  ...
  ln(Tt.postMessage)
), QE = typeof queueMicrotask < "u" ? queueMicrotask.bind(Tt) : typeof process < "u" && process.nextTick || am, k = {
  isArray: ci,
  isArrayBuffer: Zf,
  isBuffer: vE,
  isFormData: SE,
...
Pn.prototype.pipe = function() {
  var i = om.prototype.pipe.apply(this, arguments);
...
var tR = Lt, cm = _n.Stream, Jp = nR, iR = Ee;
function Ee() {
...
Ee.prototype.pipe = function(i, e) {
  return cm.prototype.pipe.call(this, i, e), this.resume(), i;
};
...
var er = { exports: {} }, Yp = dm, ER = fm, RR = mm;
er.exports = SR;
er.exports.ascending = hm;
...
}, Nc = iR, MR = Lt, $o = Re, PR = Rc, LR = Sc, FR = Ls.parse, qR = Gi, $R = _n.Stream, jo = um, jR = OR, ac = IR, DR = ce;
MR.inherits(ce, Nc);
function ce(i) {
...
function nr(i, e, t) {
  ...
  e = e || new (xm || FormData)(), t = k.toFlatObject(t, {
    metaTokens: !0,
    dots: !1,
    indexes: !1
  }, !1, function(O, C) {
  ...
  function h(_, O, C) {
    ...
    if (_ && !C && typeof _ == "object") {
      if (k.endsWith(O, "{}"))
        ...
        return O = gm(O), F.forEach(function(q, G) {
...
const ym = bm.prototype;
ym.append = function(e, t) {
  this._pairs.push([e, t]);
};
ym.toString = function(e) {
...
function Bc(i, e, t) {
  ...
  let c;
  if (o ? c = o(e, t) : c = k.isURLSearchParams(e) ? e.toString() : new bm(e, t).toString(s), c) {
    const l = i.indexOf("#");
...
const Xi = {
  ...
  transformRequest: [function(e, t) {
    ...
    if (c && k.isHTMLForm(e) && (e = new FormData(e)), k.isFormData(e))
      return o ? JSON.stringify(wm(e)) : e;
...
}, Yi = Ls, zi = Yi.URL, yS = Rc, wS = Sc, Wc = _n.Writable, Kc = H_, Rm = bS;
(function() {
...
Qe.prototype._processResponse = function(i) {
  ...
  if (Rm("redirecting to", h.href), this._isRedirect = !0, uc(h, this._options), (h.protocol !== p.protocol && h.protocol !== "https:" || h.host !== f && !TS(h.host, f)) && Go(/^(?:(?:proxy-)?authorization|cookie)$/i, this._options.headers), Mt(o)) {
    var g = {
      headers: i.headers,
      statusCode: e
    }, y = {
...
function Sm(i) {
  ...
  return Object.keys(i).forEach(function(s) {
    ...
    function p(m, h, g) {
      return OS(m) ? m = uc(m) : Ct(m) ? m = uc(Yc(m)) : (g = h, h = Am(m), m = { protocol: o }), Mt(h) && (g = h, h = null), h = Object.assign({
        maxRedirects: e.maxRedirects,
        maxBodyLength: e.maxBodyLength
      }, m, h), h.nativeProtocols = t, !Ct(h.host) && !Ct(h.hostname) && (h.hostname = "::1"), Kc.equal(h.protocol, o, "protocol mismatch"), Rm("options", h), new Qe(h, g);
    }
    function f(m, h, g) {
...
function Yc(i) {
  ...
  if (Jc)
    e = new zi(i);
  else if (e = Am(Yi.parse(i)), !Ct(e.protocol))
...
Gc.exports = Sm({ http: yS, https: wS });
Gc.exports.wrap = Sm;
var IS = Gc.exports;
...
const PS = /^(?:([^;]+);)?(?:[^;]+;)?(base64|),([\s\S]*)$/;
function LS(i, e, t) {
  const s = t && t.Blob || Le.classes.Blob, o = Tm(i);
...
const { asyncIterator: ld } = Symbol, Cm = async function* (i) {
...
class jS {
  ...
  async *encode() {
    yield this.headers;
    const { value: e } = this;
    k.isTypedArray(e) ? yield e : yield* Cm(e), yield qS;
  }
  static escapeName(e) {
...
const VS = typeof process < "u" && k.kindOf(process) === "process", XS = (i) => new Promise((e, t) => {
  ...
  return XS(async function(s, o, c) {
    ...
    if (k.isSpecCompliantForm(l)) {
      ...
      l.size && z.setContentType(l.type || "application/octet-stream"), z.setContentLength(l.size || 0), l = _n.Readable.from(Cm(l));
    ...
    !k.isUndefined(p) && (le.lookup = p), e.socketPath ? le.socketPath = e.socketPath : (le.hostname = q.hostname.startsWith("[") ? q.hostname.slice(1, -1) : q.hostname, le.port = q.port, Om(le, e.proxy, G + "//" + q.hostname + (q.port ? ":" + q.port : "") + le.path));
    let He;
...
const Im = (i) => {
...
}, tr = typeof fetch == "function" && typeof Request == "function" && typeof Response == "function", Mm = tr && typeof ReadableStream == "function", ok = tr && (typeof TextEncoder == "function" ? /* @__PURE__ */ ((i) => (e) => i.encode(e))(new TextEncoder()) : async (i) => new Uint8Array(await new Response(i).arrayBuffer())), Pm = (i, ...e) => {
  try {
    return !!i(...e);
  } catch {
    return !1;
  ...
  return i && !e;
}), gd = 64 * 1024, lc = Mm && Pm(() => k.isReadableStream(new Response("").body)), Is = {
  stream: lc && ((i) => i.body)
};
tr && ((i) => {
...
const bd = (i) => `- ${i}`, dk = (i) => k.isFunction(i) || i === null || i === !1, Lm = {
  getAdapter: (i) => {
    i = k.isArray(i) ? i : [i];
    const { length: e } = i;
    let t, s;
...
function yd(i) {
  return Ko(i), i.headers = je.from(i.headers), i.data = No.call(
    i,
    i.transformRequest
  ), ["post", "put", "patch"].indexOf(i.method) !== -1 && i.headers.setContentType("application/x-www-form-urlencoded", !1), Lm.getAdapter(i.adapter || Xi.adapter)(i).then(function(s) {
    ...
    return _m(s) || (Ko(i), s && s.response && (s.response.data = No.call(
      i,
      i.transformResponse,
      s.response
...
function qm(i) {
  const e = new Ot(i), t = Yf(Ot.prototype.request, e);
...
de.mergeConfig = Pt;
de.AxiosHeaders = je;
de.formToJSON = (i) => wm(k.isHTMLForm(i) ? new FormData(i) : i);
de.getAdapter = Lm.getAdapter;
...
async function Lk({ playlistUrl: i, categoriesUrl: e, name: t }) {
  ...
  return await ue.writeAsync(Jf(t), c), c;
}
...
async function Dk(i) {
  return await ue.readAsync(Vf(i), "json");
}
async function Nk(i) {
...
async function Hk(i) {
  ...
  let s = await ue.readAsync(It(e.name, i), "json");
...
async function Jk(i) {
  ...
  let l = await ue.readAsync(It(e.currentPlaylist.name, i), "json");
...
async function Zk(i) {
  ...
  return e.playlists.length === 0 ? e.currentPlaylist = {
    ...
    profile: "Default"
  }, await ue.removeAsync(Kf(i)), await ue.writeAsync(De, e), e;
}
function Zn(i) {
...
function bA(i, e, t, {
  ...
  for (let D = 0; D < h; D += 1) {
    ...
    G = V;
    let Ie = Math.max(1, y - V + 1), Fe = l ? g : Math.min(y + V, g) + h, Ne = Array(Fe + 2);
    Ne[Fe + 1] = (1 << D) - 1;
    for (let le = Fe; le >= Ie; le -= 1) {
...
const Ms = {
  ...
  PATH: "$path",
  PATTERN: "$val"
}, bc = (i) => !!(i[Ms.AND] || i[Ms.OR]), PA = (i) => !!i[gc.PATH], LA = (i) => !Zn(i) && Dm(i) && !bc(i), kd = (i) => ({
...
(function(i, e) {
  (function() {
    var t, s = "4.17.21", o = 200, c = "Unsupported core-js use. Try https://npms.io/search?q=ponyfill.", l = "Expected a function", p = "Invalid `variable` option passed into `_.template`", f = "__lodash_hash_undefined__", m = 500, h = "__lodash_placeholder__", g = 1, y = 2, S = 4, _ = 1, O = 2, C = 1, F = 2, $ = 4, q = 8, G = 16, z = 32, te = 64, D = 128, H = 256, V = 512, Ie = 30, Fe = "...", Ne = 800, vt = 16, le = 1, He = 2, Ln = 3, W = 1 / 0, K = 9007199254740991, Me = 17976931348623157e292, dn = NaN, he = 4294967295, Fn = he - 1, li = he >>> 1, fn = [
      ["ary", D],
      ["bind", C],
      ["bindKey", F],
      ["curry", q],
    ...
    function Uu(E) {
      for (var I = E.length; I-- && vh.test(E.charAt(I)); )
        ;
      return I;
    }
    var kv = Ar(tv);
    ...
    var Ov = function E(I) {
      I = I == null ? qe : Ut.defaults(qe.Object(), I, Ut.pick(qe, Zh));
      var A = I.Array, B = I.Date, Q = I.Error, pe = I.Function, Ce = I.Math, ve = I.Object, Mr = I.RegExp, Iv = I.String, vn = I.TypeError, la = A.prototype, Mv = pe.prototype, zt = ve.prototype, pa = I["__core-js_shared__"], da = Mv.toString, me = zt.hasOwnProperty, Pv = 0, zu = function() {
      ...
      }(), $v = I.clearTimeout !== qe.clearTimeout && I.clearTimeout, jv = B && B.now !== qe.Date.now && B.now, Dv = I.setTimeout !== qe.setTimeout && I.setTimeout, ba = Ce.ceil, ya = Ce.floor, Pr = ve.getOwnPropertySymbols, Nv = ma ? ma.isBuffer : t, Ju = I.isFinite, Bv = la.join, Uv = Bu(ve.keys, ve), Oe = Ce.max, Be = Ce.min, zv = B.now, Hv = I.parseInt, Vu = Ce.random, Gv = la.reverse, Lr = Rt(I, "DataView"), yi = Rt(I, "Map"), Fr = Rt(I, "Promise"), Ht = Rt(I, "Set"), wi = Rt(I, "WeakMap"), _i = Rt(ve, "create"), wa = wi && new wi(), Gt = {}, Wv = St(Lr), Kv = St(yi), Jv = St(Fr), Vv = St(Ht), Xv = St(wi), _a = tt ? tt.prototype : t, Ei = _a ? _a.valueOf : t, Xu = _a ? _a.toString : t;
      function v(n) {
      ...
      function Qv() {
        var n = this.__wrapped__.value(), a = this.__dir__, r = ee(n), u = a < 0, d = r ? n.length : 0, x = pg(0, d, this.__views__), b = x.start, w = x.end, R = w - b, M = u ? w : b - 1, P = this.__iteratees__, L = P.length, j = 0, U = Be(R, this.__takeCount__);
        if (!r || !u && d == R && U == R)
        ...
        e:
          for (; R-- && j < U; ) {
            ...
            for (var ie = -1, Y = n[M]; ++ie < L; ) {
              var se = P[ie], oe = se.iteratee, sn = se.type, Ke = oe(Y);
              if (sn == He)
                Y = Ke;
              else if (!Ke) {
                if (sn == le)
      ...
      function Yu(n, a) {
        var r = ee(n), u = !r && kt(n), d = !r && !u && ot(n), x = !r && !u && !d && Xt(n), b = r || u || d || x, w = b ? Cr(n.length, Iv) : [], R = w.length;
        for (var M in n)
      ...
      function Br(n, a, r) {
        for (var u = r ? Er : oa, d = n[0].length, x = n.length, b = x, w = A(x), R = 1 / 0, M = []; b--; ) {
          var P = n[b];
          b && a && (P = ye(P, nn(a))), R = Be(P.length, R), w[b] = !r && (a || d >= 120 && P.length >= 120) ? new wt(b && P) : t;
        }
        P = n[0];
        var L = -1, j = w[0];
        e:
      ...
      function Fx(n, a, r, u, d, x) {
        ...
        if (!(r & _)) {
          var U = P && me.call(n, "__wrapped__"), X = L && me.call(a, "__wrapped__");
          if (U || X) {
      ...
      function ql(n) {
        return function(a) {
          var r = Ue(a);
          return r == En ? Ir(a) : r == Rn ? Ev(a) : hv(a, n(a));
        };
      }
      function Wn(n, a, r, u, d, x, b, w) {
        ...
        if (j && wg(U, j), n = U[0], a = U[1], r = U[2], u = U[3], d = U[4], w = U[9] = U[9] === t ? R ? 0 : n.length : Oe(U[9] - M, 0), !w && a & (q | G) && (a &= ~(q | G)), !a || a == C)
          var X = ig(n, a, r);
        else a == q || a == G ? X = ag(n, a, w) : (a == z || a == (C | z)) && !d.length ? X = sg(n, a, r, u) : X = Ia.apply(t, U);
        var ie = j ? vl : Kl;
...
`);
      ...
      var Kl = Vl(vl), Ii = Dv || function(n, a) {
      ...
      function gp(n) {
        ...
        if (bi && n[bi])
          return _v(n[bi]());
        var a = Ue(n), r = a == En ? Ir : a == Rn ? ua : Yt;
        return r(n);
      }
      function Xn(n) {
        if (!n)
      ...
      var Xy = ae(function(n, a) {
        ...
        for (d && We(a[0], a[1], d) && (u = 1); ++r < u; )
          for (var x = a[r], b = Xe(x), w = -1, R = b.length; ++w < R; ) {
            var M = b[w], P = n[M];
            (P === t || An(P, zt[M]) && !me.call(n, M)) && (n[M] = x[M]);
          }
        return n;
      }), Yy = ae(function(n) {
      ...
      function Sw(n, a, r) {
        return a = Xn(a), r === t ? (r = a, a = 0) : r = Xn(r), n = wn(n), Ix(n, a, r);
      }
      function kw(n, a, r) {
...
`) + L + `return __p
      ...
      function Xw(n, a) {
        ...
        if (b && (w += R.length - w), xo(d)) {
          if (n.slice(w).search(d)) {
            var M, P = R;
            for (d.global || (d = Mr(d.source, fe(ru.exec(d)) + "g")), d.lastIndex = 0; M = d.exec(P); )
              var L = M.index;
            R = R.slice(0, L === t ? w : L);
          }
      ...
      var p_ = eo(ye), d_ = eo(Pu), f_ = eo(Sr);
      function Op(n) {
      ...
      return v.after = sy, v.ary = op, v.assign = Wy, v.assignIn = wp, v.assignInWith = Ga, v.assignWith = Ky, v.at = Jy, v.before = cp, v.bind = mo, v.bindAll = Qw, v.bindKey = up, v.castArray = xy, v.chain = ap, v.chunk = kg, v.compact = Ag, v.concat = Tg, v.cond = e_, v.conforms = n_, v.constant = wo, v.countBy = qb, v.create = Vy, v.curry = lp, v.curryRight = pp, v.debounce = dp, v.defaults = Xy, v.defaultsDeep = Yy, v.defer = ry, v.delay = oy, v.difference = Cg, v.differenceBy = Og, v.differenceWith = Ig, v.drop = Mg, v.dropRight = Pg, v.dropRightWhile = Lg, v.dropWhile = Fg, v.fill = qg, v.filter = jb, v.flatMap = Bb, v.flatMapDeep = Ub, v.flatMapDepth = zb, v.flatten = ep, v.flattenDeep = $g, v.flattenDepth = jg, v.flip = cy, v.flow = i_, v.flowRight = a_, v.fromPairs = Dg, v.functions = aw, v.functionsIn = sw, v.groupBy = Hb, v.initial = Bg, v.intersection = Ug, v.intersectionBy = zg, v.intersectionWith = Hg, v.invert = ow, v.invertBy = cw, v.invokeMap = Wb, v.iteratee = _o, v.keyBy = Kb, v.keys = Pe, v.keysIn = Xe, v.map = Da, v.mapKeys = lw, v.mapValues = pw, v.matches = s_, v.matchesProperty = r_, v.memoize = Ba, v.merge = dw, v.mergeWith = _p, v.method = o_, v.methodOf = c_, v.mixin = Eo, v.negate = Ua, v.nthArg = l_, v.omit = fw, v.omitBy = mw, v.once = uy, v.orderBy = Jb, v.over = p_, v.overArgs = ly, v.overEvery = d_, v.overSome = f_, v.partial = ho, v.partialRight = fp, v.partition = Vb, v.pick = hw, v.pickBy = Ep, v.property = Op, v.propertyOf = m_, v.pull = Jg, v.pullAll = tp, v.pullAllBy = Vg, v.pullAllWith = Xg, v.pullAt = Yg, v.range = h_, v.rangeRight = v_, v.rearg = py, v.reject = Zb, v.remove = Zg, v.rest = dy, v.reverse = po, v.sampleSize = ey, v.set = xw, v.setWith = gw, v.shuffle = ny, v.slice = Qg, v.sortBy = ay, v.sortedUniq = rb, v.sortedUniqBy = ob, v.split = Bw, v.spread = fy, v.tail = cb, v.take = ub, v.takeRight = lb, v.takeRightWhile = pb, v.takeWhile = db, v.tap = Ab, v.throttle = my, v.thru = ja, v.toArray = gp, v.toPairs = Rp, v.toPairsIn = Sp, v.toPath = w_, v.toPlainObject = yp, v.transform = bw, v.unary = hy, v.union = fb, v.unionBy = mb, v.unionWith = hb, v.uniq = vb, v.uniqBy = xb, v.uniqWith = gb, v.unset = yw, v.unzip = fo, v.unzipWith = ip, v.update = ww, v.updateWith = _w, v.values = Yt, v.valuesIn = Ew, v.without = bb, v.words = Tp, v.wrap = vy, v.xor = yb, v.xorBy = wb, v.xorWith = _b, v.zip = Eb, v.zipObject = Rb, v.zipObjectDeep = Sb, v.zipWith = kb, v.entries = Rp, v.entriesIn = Sp, v.extend = wp, v.extendWith = Ga, Eo(v, v), v.add = E_, v.attempt = Cp, v.camelCase = Aw, v.capitalize = kp, v.ceil = R_, v.clamp = Rw, v.clone = gy, v.cloneDeep = yy, v.cloneDeepWith = wy, v.cloneWith = by, v.conformsTo = _y, v.deburr = Ap, v.defaultTo = t_, v.divide = S_, v.endsWith = Tw, v.eq = An, v.escape = Cw, v.escapeRegExp = Ow, v.every = $b, v.find = Db, v.findIndex = Zl, v.findKey = Zy, v.findLast = Nb, v.findLastIndex = Ql, v.findLastKey = Qy, v.floor = k_, v.forEach = sp, v.forEachRight = rp, v.forIn = ew, v.forInRight = nw, v.forOwn = tw, v.forOwnRight = iw, v.get = go, v.gt = Ey, v.gte = Ry, v.has = rw, v.hasIn = bo, v.head = np, v.identity = Ye, v.includes = Gb, v.indexOf = Ng, v.inRange = Sw, v.invoke = uw, v.isArguments = kt, v.isArray = ee, v.isArrayBuffer = Sy, v.isArrayLike = Ve, v.isArrayLikeObject = ke, v.isBoolean = ky, v.isBuffer = ot, v.isDate = Ay, v.isElement = Ty, v.isEmpty = Cy, v.isEqual = Oy, v.isEqualWith = Iy, v.isError = vo, v.isFinite = My, v.isFunction = Vn, v.isInteger = mp, v.isLength = za, v.isMap = hp, v.isMatch = Py, v.isMatchWith = Ly, v.isNaN = Fy, v.isNative = qy, v.isNil = jy, v.isNull = $y, v.isNumber = vp, v.isObject = we, v.isObjectLike = _e, v.isPlainObject = Mi, v.isRegExp = xo, v.isSafeInteger = Dy, v.isSet = xp, v.isString = Ha, v.isSymbol = an, v.isTypedArray = Xt, v.isUndefined = Ny, v.isWeakMap = By, v.isWeakSet = Uy, v.join = Gg, v.kebabCase = Iw, v.last = yn, v.lastIndexOf = Wg, v.lowerCase = Mw, v.lowerFirst = Pw, v.lt = zy, v.lte = Hy, v.max = A_, v.maxBy = T_, v.mean = C_, v.meanBy = O_, v.min = I_, v.minBy = M_, v.stubArray = So, v.stubFalse = ko, v.stubObject = x_, v.stubString = g_, v.stubTrue = b_, v.multiply = P_, v.nth = Kg, v.noConflict = u_, v.noop = Ro, v.now = Na, v.pad = Lw, v.padEnd = Fw, v.padStart = qw, v.parseInt = $w, v.random = kw, v.reduce = Xb, v.reduceRight = Yb, v.repeat = jw, v.replace = Dw, v.result = vw, v.round = L_, v.runInContext = E, v.sample = Qb, v.size = ty, v.snakeCase = Nw, v.some = iy, v.sortedIndex = eb, v.sortedIndexBy = nb, v.sortedIndexOf = tb, v.sortedLastIndex = ib, v.sortedLastIndexBy = ab, v.sortedLastIndexOf = sb, v.startCase = Uw, v.startsWith = zw, v.subtract = F_, v.sum = q_, v.sumBy = $_, v.template = Hw, v.times = y_, v.toFinite = Xn, v.toInteger = ne, v.toLength = bp, v.toLower = Gw, v.toNumber = wn, v.toSafeInteger = Gy, v.toString = fe, v.toUpper = Ww, v.trim = Kw, v.trimEnd = Jw, v.trimStart = Vw, v.truncate = Xw, v.unescape = Yw, v.uniqueId = __, v.upperCase = Zw, v.upperFirst = yo, v.each = sp, v.eachRight = rp, v.first = np, Eo(v, function() {
        ...
        name: "wrapper",
        func: t
      }], re.prototype.clone = Yv, re.prototype.reverse = Zv, re.prototype.value = Qv, v.prototype.at = Tb, v.prototype.chain = Cb, v.prototype.commit = Ob, v.prototype.next = Ib, v.prototype.plant = Pb, v.prototype.reverse = Lb, v.prototype.toJSON = v.prototype.valueOf = v.prototype.value = Fb, v.prototype.first = v.prototype.head, bi && (v.prototype[bi] = Mb), v;
    }, Ut = Ov();
...
async function GA({ apiKey: i, playlistName: e }) {
  const t = new Km.MovieDb(i), o = (await t.moviePopular({ language: "pt" })).results, c = await $m(e);
...
var eT = yc.exports, wc = Re, nT = W_.spawn, Xm = eT("electron-squirrel-startup"), Xo = N_.app, Pd = function(i, e) {
  var t = wc.resolve(wc.dirname(process.execPath), "..", "Update.exe");
  Xm("Spawning `%s` with args `%s`", t, i), nT(t, i, {
    detached: !0
  }).on("close", e);
}, tT = function() {
  if (process.platform === "win32") {
...
const aT = /* @__PURE__ */ Ac(iT), Ym = pt.dirname(B_(import.meta.url));
process.env.APP_ROOT = pt.join(Ym, "..");
const _c = process.env.VITE_DEV_SERVER_URL, TT = pt.join(process.env.APP_ROOT, "dist-electron"), Zm = pt.join(process.env.APP_ROOT, "dist");
