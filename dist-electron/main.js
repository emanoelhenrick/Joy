...
import B_, { app as ti, ipcMain as be, BrowserWindow as Fd } from "electron";
...
function VA(i) {
  be.handle("get-metadata", qt), be.handle("authenticate-user", async (e, t) => await $k(t)), be.handle("fetch-tmdb-trending", async (e, t) => await GA(t)), be.handle("update-vod", async (e, t) => await Lk(t)), be.handle("update-series", async (e, t) => await Fk(t)), be.handle("update-live", async (e, t) => await qk(t)), be.handle("add-playlist-to-meta", async (e, t) => await jk(t)), be.handle("edit-playlist-info", async (e, t) => await JA(t)), be.handle("remove-playlist", async (e, t) => await Zk(t)), be.handle("get-local-vod-playlist", async (e, t) => await jm(t)), be.handle("get-local-series-playlist", async (e, t) => await Dk(t)), be.handle("get-local-live-playlist", async (e, t) => await Nk(t)), be.handle("get-playlist-info", async (e, t) => await Bk(t)), be.handle("get-vod-info", async (e, t) => await Uk(t)), be.handle("get-serie-info", async (e, t) => await zk(t)), be.handle("get-user-data", async (e, t) => await Hk(t)), be.handle("update-user-data", async (e, t) => await Gk(t)), be.handle("change-current-playlist", async (e, t) => await Wk(t)), be.handle("updated-at-playlist", async (e, t) => await Kk(t)), be.handle("create-profile", async (e, t) => await Jk(t)), be.handle("switch-profile", async (e, t) => await Vk(t)), be.handle("rename-profile", async (e, t) => await Xk(t)), be.handle("remove-profile", async (e, t) => await Yk(t)), be.handle("launch-vlc", async (e, t) => WA(t, i)), be.handle("get-vlc-state", async (e) => await KA());
}
...
var QA = yc.exports, wc = Re, eT = K_.spawn, Ym = QA("electron-squirrel-startup"), Xo = B_.app, Ld = function(i, e) {
  var t = wc.resolve(wc.dirname(process.execPath), "..", "Update.exe");
  Ym("Spawning `%s` with args `%s`", t, i), eT(t, i, {
    detached: !0
  }).on("close", e);
}, nT = function() {
  if (process.platform === "win32") {
...
const iT = /* @__PURE__ */ Ac(tT), Zm = pt.dirname(U_(import.meta.url));
process.env.APP_ROOT = pt.join(Zm, "..");
const _c = process.env.VITE_DEV_SERVER_URL, AT = pt.join(process.env.APP_ROOT, "dist-electron"), Qm = pt.join(process.env.APP_ROOT, "dist");
