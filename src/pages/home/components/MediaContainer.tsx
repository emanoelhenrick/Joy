...
export function MediaContainer({ title, length, children }: { title: string, length?: number, children?: any }) {
    ...
    <div className="w-full p-5 rounded-2xl bg-primary-foreground">
      <div className='flex justify-between items-center mb-4'>
        <div className="flex gap-3 items-center">
          ...
          {length && <h1 className="text-muted-foreground text-sm font-medium p-0">{length}</h1>}
        </div>
