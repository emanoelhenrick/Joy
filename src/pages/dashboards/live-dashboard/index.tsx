...
import { getLocalLivePlaylist } from "@/core/files/getLocalLivePlaylist";
...
export function LiveDashboard() {
  ...
  const { data, isFetched } = useQuery({ queryKey: ['LivePlaylist'], queryFn: () => getLocalLivePlaylist(playlistName!), staleTime: Infinity })
  ...
  return (
    <div className="h-screen flex">
      <MenuBar playlist={playlistName} tab='live-dashboard' />
