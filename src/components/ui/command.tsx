  ...
  return (
    <Dialog {...props}>
      ...
      <DialogContent className="overflow-hidden p-0 sm:max-w-2xl [&>button:last-child]:hidden">
        <Command shouldFilter={false} className="[&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:font-medium [&_[cmdk-group-heading]]:text-muted-foreground [&_[cmdk-group]]:px-2 [&_[cmdk-input]]:h-12 [&_[cmdk-item]]:px-3 [&_[cmdk-item]]:py-2">
          {children}
        </Command>
      </DialogContent>
    </Dialog>
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.List
    ref={ref}
    className={cn("max-h-[30rem] overflow-y-auto overflow-x-hidden", className)}
    {...props}
  />
));
