...
export const Dots_v3 = () => {
  return (
    <div className="flex items-center justify-center space-x-1 text-5xl">
      <h1 className="animate-bounce [animation-delay:-0.3s]">J</h1>
      <h1 className="animate-bounce [animation-delay:-0.13s]">O</h1>
      <h1 className="animate-bounce">Y</h1>
    </div>
  )
}
